...
def update_hr_setting(value=0):
	hr_settings = frappe.get_doc({
		"doctype": "HR Settings",
		"time_sheet_for_salary_slip": value
	})

	hr_settings.save()

def update_accounts_setting(value=0):
	accounts_settings = frappe.get_doc({
		"doctype": "Accounts Settings",
		"time_sheet_for_sales_invoice": value
	})
