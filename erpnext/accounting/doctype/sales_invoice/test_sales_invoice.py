...
from erpnext.accounting.doctype.purchase_invoice.test_purchase_invoice import unlink_payment_on_cancel_of_invoice
...
class TestSalesInvoice(unittest.TestCase):
	...
	def test_make_pos_invoice(self):
		from erpnext.accounting.doctype.sales_invoice.pos import make_invoice
