...
erpnext.accounting.SalesInvoiceController = erpnext.selling.SellingController.extend({
	setup: function(doc) {
	...
	customer: function() {
		...
		erpnext.utils.get_party_details(this.frm,
			"erpnext.accounting.party.get_party_details", {
		...
		if(this.frm.doc.customer) {
			frappe.call({
				"method": "erpnext.accounting.doctype.sales_invoice.sales_invoice.get_loyalty_programs",
				"args": {
	...
	make_inter_company_invoice: function() {
		frappe.model.open_mapped_doc({
			method: "erpnext.accounting.doctype.sales_invoice.sales_invoice.make_inter_company_purchase_invoice",
			frm: me.frm
		});
	},
	...
	make_sales_return: function() {
		frappe.model.open_mapped_doc({
			method: "erpnext.accounting.doctype.sales_invoice.sales_invoice.make_sales_return",
			frm: cur_frm
		})
	},
...
$.extend(cur_frm.cscript, new erpnext.accounting.SalesInvoiceController({frm: cur_frm}));
...
cur_frm.cscript['Make Delivery Note'] = function() {
	frappe.model.open_mapped_doc({
		method: "erpnext.accounting.doctype.sales_invoice.sales_invoice.make_delivery_note",
		frm: cur_frm
	})
}
