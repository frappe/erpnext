...
from erpnext.accounting.doctype.sales_invoice.pos import update_multi_mode_option
...
from erpnext.accounting.doctype.loyalty_program.loyalty_program import \
...
class SalesInvoice(SellingController):
	...
	def get_gl_entries(self, warehouse_account=None):
		from erpnext.accounting.general_ledger import merge_similar_entries
	...
	def apply_loyalty_points(self):
		from erpnext.accounting.doctype.loyalty_point_entry.loyalty_point_entry \
