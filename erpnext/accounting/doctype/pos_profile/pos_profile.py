...
from erpnext.accounting.doctype.sales_invoice.pos import get_child_nodes
from erpnext.accounting.doctype.sales_invoice.sales_invoice import set_account_for_mode_of_payment
