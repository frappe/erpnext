...
def get_chart(chart_template, existing_company=None):
	...
	if existing_company:
		...
		from erpnext.accounting.doctype.account.chart_of_accounts.verified import standard_chart_of_accounts
		return standard_chart_of_accounts.get()
	elif chart_template == "Standard with Numbers":
		from erpnext.accounting.doctype.account.chart_of_accounts.verified \
