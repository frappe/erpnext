...
erpnext.accounting.PaymentReconciliationController = frappe.ui.form.Controller.extend({
	onload: function() {
		var me = this;
...
$.extend(cur_frm.cscript, new erpnext.accounting.PaymentReconciliationController({frm: cur_frm}));
