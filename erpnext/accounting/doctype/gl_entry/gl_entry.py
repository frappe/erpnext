...
from erpnext.accounting.party import validate_party_gle_currency, validate_party_frozen_disabled
...
class GLEntry(Document):
	...
	def pl_must_have_cost_center(self):
		if frappe.db.get_value("Account", self.account, "report_type") == "Profit and Loss":
			...
			from erpnext.accounting.utils import get_allow_cost_center_in_entry_of_bs_account
