...
class TestPurchaseInvoice(unittest.TestCase):
	...
	def test_payment_entry_unlink_against_purchase_invoice(self):
		from erpnext.accounting.doctype.payment_entry.test_payment_entry import get_payment_entry
		unlink_payment_on_cancel_of_invoice(0)
	...
	def test_purchase_invoice_with_advance(self):
		from erpnext.accounting.doctype.journal_entry.test_journal_entry \
	...
	def test_purchase_invoice_with_shipping_rule(self):
		from erpnext.accounting.doctype.shipping_rule.test_shipping_rule \
	...
	def test_debit_note(self):
		from erpnext.accounting.doctype.payment_entry.test_payment_entry import get_payment_entry
		from erpnext.accounting.doctype.sales_invoice.test_sales_invoice import get_outstanding_amount
