...
erpnext.accounting.PurchaseInvoice = erpnext.buying.BuyingController.extend({
	setup: function(doc) {
	...
	unblock_invoice: function() {
		const me = this;
		frappe.call({
			'method': 'erpnext.accounting.doctype.purchase_invoice.purchase_invoice.unblock_invoice',
	...
	make_comment_dialog_and_block_invoice: function(){
		...
		this.dialog.set_primary_action(__('Save'), function() {
			...
			frappe.call({
				'method': 'erpnext.accounting.doctype.purchase_invoice.purchase_invoice.block_invoice',
	...
	set_release_date: function(data) {
		return frappe.call({
			'method': 'erpnext.accounting.doctype.purchase_invoice.purchase_invoice.change_release_date',
			'args': data,
	...
	supplier: function() {
		...
		if(this.frm.updating_party_details)
			return;
		erpnext.utils.get_party_details(this.frm, "erpnext.accounting.party.get_party_details",
			{
	...
	make_inter_company_invoice: function(frm) {
		frappe.model.open_mapped_doc({
			method: "erpnext.accounting.doctype.purchase_invoice.purchase_invoice.make_inter_company_sales_invoice",
			frm: frm
		});
	},
	...
	make_debit_note: function() {
		frappe.model.open_mapped_doc({
			method: "erpnext.accounting.doctype.purchase_invoice.purchase_invoice.make_debit_note",
			frm: cur_frm
		})
	},
...
cur_frm.script_manager.make(erpnext.accounting.PurchaseInvoice);
