...
# imported to enable erpnext.accounting.utils.get_account_currency
from erpnext.accounting.doctype.account.account import get_account_currency
...
def get_children(doctype, parent, company, is_root=False):
	from erpnext.accounting.report.financial_statements import sort_accounts
...
def get_coa(doctype, parent, is_root, chart=None):
	from erpnext.accounting.doctype.account.chart_of_accounts.chart_of_accounts import build_tree_from_json
