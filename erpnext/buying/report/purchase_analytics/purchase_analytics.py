...
from erpnext.selling.report.sales_analytics.sales_analytics import (get_columns, get_period,
	get_period_date_ranges, get_chart_data, get_type_data, get_by_group, get_data_list, get_item_entry, 
...
def gen_data(filters):
	...
	if filters["tree_type"] == 'Supplier':
		...
		return get_type_data(filters,entry,suppliers)
		...
		return get_by_group(filters, supplier, entry)
