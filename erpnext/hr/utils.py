...
def allocate_earned_leaves():
	...
	for e_leave_type in e_leave_types:
		leave_allocations = frappe.db.sql("""select name, employee, from_date, to_date, leave_policy_assignment, leave_policy from `tabLeave Allocation` where %s
		...
		for allocation in leave_allocations:
			...
			annual_allocation = frappe.db.get_value("Leave Policy Detail", filters={
				'parent': allocation.leave_policy,
...
def check_frequency_hit(from_date, to_date, frequency, based_on_date_of_joining_date):
	import calendar
