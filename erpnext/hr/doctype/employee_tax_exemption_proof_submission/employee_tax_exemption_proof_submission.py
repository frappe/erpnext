...
from erpnext.hr.utils import validate_tax_declaration, get_total_exemption_amount, calculate_hra_exemption_for_period, validate_single_exemption_for_single_payroll_period
...
class EmployeeTaxExemptionProofSubmission(Document):
	def validate(self):
		...
		validate_single_exemption_for_single_payroll_period(self.doctype, self.payroll_period)
