...
class TestEmployeeLoanApplication(unittest.TestCase):
	def setUp(self):
		...
		make_employee("kate_loan@loan.com")
	...
	def create_loan_application(self):
		if not frappe.db.get_value("Employee Loan Application", {"employee":"kate_loan@loan.com"}, "name"):
			frappe.get_doc({
				"doctype": "Employee Loan Application",
				"employee": "kate_loan@loan.com",
				"loan_type": "Home Loan",
				"rate_of_interest": 9.2,
				"loan_amount": 250000,
	...
	def test_loan_totals(self):
		loan_application = frappe.get_doc("Employee Loan Application", {"employee":"kate_loan@loan.com"}, "name")
		self.assertEquals(loan_application.emi_amount, 11445)
		...
		loan_application.emi_amount = 15000
