...
class Grade(Document):
    ...
    # def set_gosi(self):
    #     abbr=frappe.get_value("Salary Detail", filters={"parent": self.name, "salary_component": "Basic"}, fieldname="abbr")
    #     if abbr:  
    #         for e in self.get("earnings"):
    #             if e.salary_component == "Housing":
    #                 housing_formula = e.formula
    #         if housing_formula and abbr in housing_formula:
    #             basic = self.calculate_main_basic()
