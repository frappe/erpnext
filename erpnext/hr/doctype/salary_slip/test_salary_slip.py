...
class TestSalarySlip(unittest.TestCase):
	def setUp(self):
		...
		create_tax_slab( "Tax Slab: " + payroll_period.name, effective_date =  payroll_period.start_date, allow_tax_exemption=True)
...
def create_tax_slab(income_tax_slab_name, effective_date = None, allow_tax_exemption = False, dont_submit = False):
	print(effective_date)
	if frappe.db.exists("Income Tax Slab", income_tax_slab_name):
		return
	...
	income_tax_slab.effective_from = effective_date or add_months(nowdate(), -8)
