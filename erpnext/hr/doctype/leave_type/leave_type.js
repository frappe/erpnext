...
frappe.tour['Leave Type'] = [
	{
		...
		description: __("This field allows you to set the maximum number of the annual allocation of this Leave Type while creating the Leave Policy")
	},
	{
		fieldname: "max_continuous_days_allowed",
		title: "Maximum Consecutive Leaves Allowed",
		description: __("This field allows you to set the maximum number of consecutive leaves for which Employee can apply")
	},
	{
	...
	},
	{
		...
		description: __("Leaves you can avail against a holiday you worked on. You can claim Comp-off Leave using Compensatory Leave request. Click here to learn more")
	},
	{
	...
	},
	{
		...
		description: __("Enable this to allocate Leave as Employee works for certain time duration.")
	}
];
