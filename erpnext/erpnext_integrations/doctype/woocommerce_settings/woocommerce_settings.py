	...
	def create_delete_custom_fields(self):
		if self.enable_sync:
			...
			for doctype in ["Customer", "Sales Order", "Item", "Address"]:
				...
				df = dict(fieldname='woocommerce_check', label='Woocommerce Check', fieldtype='Check', read_only=1, print_hide=1)
				create_custom_field(doctype, df)
			...
			"Customer-woocommerce_check", "Sales Order-woocommerce_check", "Item-woocommerce_check", "Address-woocommerce_check", "Customer-woocommerce_email", "Address-woocommerce_email"]
