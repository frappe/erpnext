...
def validate_gstin_for_india(doc, method):
	...
	if gst_category and gst_category == 'UIN Holders':
		...
		if not p.match(doc.gstin):
			frappe.throw(_("Invalid GSTIN! The input you've entered doesn't match the GSTIN format for UIN Holders or Non-Resident OIDAR Service Providers"), title=_("Invalid GSTIN"))
	else:
