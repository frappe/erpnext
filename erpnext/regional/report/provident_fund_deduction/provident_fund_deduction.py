...
def get_data(filters):
	...
	employee_account_dict = frappe._dict(frappe.db.sql(""" select employee_name, provident_fund_account from `tabEmployee`"""))
	...
	for d in entry:
		...
		employee = {
			...
			"pf_account": employee_account_dict.get(d.employee_name)
		}
