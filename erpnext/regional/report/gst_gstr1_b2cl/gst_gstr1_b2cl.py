			...
			for tax_rate in invoice_tax_map[inv]:
				...
				if tax_rate != 0:
					...
					if invoice_tax_map[inv][tax_rate]["tax_rate"] != 0:
						...
						datum =datum+[invoice_tax_map[inv][tax_rate]["tax_rate"],invoice_tax_map[inv][tax_rate]["inv_value"],invoice_tax_map[inv][tax_rate]["cess"],invoice_dict[inv]["ecommerce_gstin"]]
						data.append(datum)
