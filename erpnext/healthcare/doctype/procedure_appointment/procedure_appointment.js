...
var btn_update_status = function(frm, status){
	...
	frappe.call({
		method:
		"erpnext.healthcare.doctype.procedure_appointment.procedure_appointment.update_status",
...
var invoice_procedure_appointment = function (frm){
	var doc = frm.doc;
	frappe.call({
		method:"erpnext.healthcare.doctype.procedure_appointment.procedure_appointment.create_invoice",
...
var btn_create_procedure = function(frm){
	var doc = frm.doc;
	frappe.call({
		method:"erpnext.healthcare.doctype.procedure_appointment.procedure_appointment.create_procedure",
...
var check_availability = function(frm){
	if(frm.doc.service_type && frm.doc.date){
		frappe.call({
			method:
			"erpnext.healthcare.doctype.procedure_appointment.procedure_appointment.btn_check_availability",
...
var get_procedures_rx = function(frm){
	if(frm.doc.patient){
		frappe.call({
			method:
			"erpnext.healthcare.doctype.procedure_appointment.procedure_appointment.get_procedures_rx",
