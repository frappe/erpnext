...
var disable_facility_type = function(frm){
	var doc = frm.doc;
	frappe.call({
		method: 		"erpnext.healthcare.doctype.facility_type.facility_type.disable_enable_facility_type",
...
var change_item_code = function(frm,doc){
	var d = new frappe.ui.Dialog({
		...
		var btn_change_item_code = function(item_code,doc){
			frappe.call({
				"method": "erpnext.healthcare.doctype.facility_type.facility_type.change_item_code",
