	...
	get_variant_fields() {
		var variant_fields = [
			...
			},
			{
				...
				fieldtype: "Data",
				mandatory_depends_on: "eval:doc.city || doc.country || doc.address_line2 || doc.pincode || doc.state",
			},
			{
			...
			},
			{
				...
				fieldname: "city",
				fieldtype: "Data",
				mandatory_depends_on: "eval:doc.country || doc.address_line1 || doc.address_line2 || doc.pincode || doc.state",
			},
			{
			...
			},
			{
				...
				fieldtype: "Link",
				options: "Country",
				mandatory_depends_on: "eval:doc.city || doc.address_line1 || doc.address_line2 || doc.pincode || doc.state",
			},
			{
