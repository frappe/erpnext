...
def execute(filters=None):
	...
	columns= [_("Date") + "::240", _("No Bank Deposit") + "::240", _("Amount") + ":Currency:120", _("Party Name") + "::240", _("Remarks") + "::240", _("Created By") + "::240"] 
...
def return_data(filters):
	...
	for pay in payments:
		row = [pay.deposit_date, pay.document, pay.amount_bd, pay.person_name, pay.movement_detail, pay.created_by]
		data.append(row)
