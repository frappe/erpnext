...
class StatementOfAccountsReceivable(object):
    ...
    def get_chart_data(self, columns, data):
        ...
        if rows:
            rows.insert(0, [[d] for d in ageing_columns])
...
def execute(filters=None):
    ...
    return StatementOfAccountsReceivable(filters).run(args)
