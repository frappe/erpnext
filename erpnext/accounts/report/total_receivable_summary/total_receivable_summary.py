...
class AccountsReceivableSummary(ReceivablePayableReport):
	...
	def get_columns(self, party_naming_by, args):
		...
		columns=["Aging Period:Data:140" ,  "Period Total:Currency/currency:160"]
		return columns
	...
	def get_data(self, party_naming_by, args):
		...
		for d in data:
			...
			total_range4+=d[9]
		total_summary_data=[] 	
		total_summary_data= ["0-" + str(self.filters.range1) , total_range1 ], [str(self.filters.range1) + "-" + str(self.filters.range2), total_range2 ],[str(self.filters.range2) + "-" + str(self.filters.range3), total_range3], [str(self.filters.range3) + _("-Above"), total_range4]
		
		return total_summary_data
