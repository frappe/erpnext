...
def execute(filters=None):
	...
	columns = [_("Date") + "::240", _("Serie") + "::240", _("Naming Series") + "::240", _("Gross Amount") + ":Currency:120", _("Exempts Sales") + ":Currency:120", _("Exonerated") + ":Currency:120", _("Taxed Sales 15%") + ":Currency:120", _("I.S.V 15%") + ":Currency:120", _("Taxed Sales 18%") + ":Currency:120", _("I.S.V 18%") + ":Currency:120", _("Partial Discount") + ":Currency:120" ,_("Discount Amount") + ":Currency:120", _("Disount Reason") + "::240", _("Total") + ":Currency:120"]
...
def return_data(filters):
	...
	for salary_slip in salary_slips:
		...
		row = [creation_date, serie_final, final_range, gross, total_exempt, total_exonerated, taxed_sales15, isv15, taxed_sales18, isv18, partial_discount, discount_amount, discount_reason, grand_total]
		data.append(row)
