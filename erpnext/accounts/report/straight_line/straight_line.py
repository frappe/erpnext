...
def execute(filters=None):
	...
	(assets.gross_purchase_value - deprtilllastyr) < (assets.gross_purchase_value * rateofdepr / 100) :
	        row = [fixed_asset_name,
	               fixed_asset_account,
	               rateofdepr,
	               flt(opening_balance,2),
	               ...
	               flt(depronpurchases,2),
	               flt(deprwrittenback,2),
	               flt(((deprtilllastyr + (assets.gross_purchase_value - deprtilllastyr)) - deprwrittenback),2)]
	else:
	        row = [fixed_asset_name,
	               fixed_asset_account,
	               rateofdepr,
