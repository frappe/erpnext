...
def return_data(filters):
	...
	for advance in advances:
		...
		row = [advance.name, advance.party, advance.references_nos, advance.remarks, advance.payment_type, advance.posting_date, advance.mode_of_payment, advance.party_type, advance.party, amount]
