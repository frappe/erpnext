...
def return_data(filters):
	...
	for payment_entry in payment_entries:
		row = [payment_entry.posting_date, payment_entry.party, "Payment Entry", payment_entry.name, payment_entry.mode_of_payment, payment_entry.total_allocated_amount, payment_entry.paid_amount, payment_entry.unallocated_amount, payment_entry.paid_to_account_currency]
		data.append(row)
