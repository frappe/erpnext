...
def _get_party_details(party=None, account=None, party_type="Customer", company=None, posting_date=None,
	bill_date=None, price_list=None, currency=None, doctype=None, ignore_permissions=False, fetch_payment_terms_template=True, customer_address=None):
	...
	set_address_details(out, party, party_type, doctype, company, customer_address)
...
def set_address_details(out, party, party_type, doctype=None, company=None, customer_address=None):  
	billing_address_field = "customer_address" if party_type == "Lead" \
		else party_type.lower() + "_address"
	out[billing_address_field] = customer_address or get_default_address(party_type, party.name)
	if doctype:
