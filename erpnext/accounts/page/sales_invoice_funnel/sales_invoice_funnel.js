...
frappe.pages['sales-invoice-funnel'].on_page_load = function(wrapper) {
	frappe.ui.make_app_page({
		parent: wrapper,
		title: __('Sales Invoice Funnel'),
		single_column: true
	});
...
erpnext.SalesFunnel = Class.extend({
	...
	get_data: function(btn) {
		var me = this;
		frappe.call({
			method: "erpnext.accounts.page.sales_invoice_funnel.sales_invoice_funnel.get_funnel_data",
			args: {
