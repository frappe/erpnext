...
class PurchaseInvoice(BuyingController):
	...
	def make_gle_for_rounding_adjustment(self, gl_entries):
		...
		# eg: rounding_adjustment = 0.01 and exchange rate = 0.05 a and precision of base_rounding_adjustment is 2
		#	then base_rounding_adjustment becomes zero error is thrown in GL Entry
