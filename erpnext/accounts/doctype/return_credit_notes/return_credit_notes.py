...
class Returncreditnotes(SellingController):
	def __init__(self, *args, **kwargs):
		super(Returncreditnotes, self).__init__(*args, **kwargs)
		self.status_updater = [{
	...
	def validate(self):
		super(Returncreditnotes, self).validate()
	...
	def on_cancel(self):
		super(Returncreditnotes, self).on_cancel()
	...
	def set_missing_values(self, for_validate=False):
		...
		super(Returncreditnotes, self).set_missing_values(for_validate)
	...
	def validate_with_previous_doc(self):
		super(Returncreditnotes, self).validate_with_previous_doc({
			"Sales Order": {
	...
	def validate_warehouse(self):
		super(Returncreditnotes, self).validate_warehouse()
	...
	def make_item_gl_entries(self, gl_entries):
		...
		if cint(self.update_stock) and \
			...
			gl_entries += super(Returncreditnotes, self).get_gl_entries()
