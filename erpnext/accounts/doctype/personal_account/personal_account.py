...
class InvalidPersonalAccount(ValidationError): pass

class PersonalAccount(AccountsController):
...
def get_account_details(account, date):
	frappe.has_permission('Personal Account', throw=True)
	return frappe._dict({
...
def get_payment_entry(dt, dn, party_amount=None, bank_account=None, bank_amount=None):
	...
	pe = frappe.new_doc("Personal Account")
