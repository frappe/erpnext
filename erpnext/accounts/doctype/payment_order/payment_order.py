...
def get_mop_query(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def get_supplier_query(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
	return frappe.db.sql(
