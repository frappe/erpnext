...
from Goldfish.accounts.doctype.pos_closing_entry.pos_closing_entry import (
...
from Goldfish.accounts.doctype.pos_opening_entry.test_pos_opening_entry import create_opening_entry
