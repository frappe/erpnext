...
class Subscription(Document):
	...
	def get_status_for_past_grace_period(self):
	...
	def is_past_grace_period(self):
		...
		return getdate(frappe.flags.current_date) > getdate(add_days(self.current_invoice.due_date, grace_period))
