...
class JournalEntry(AccountsController):
	...
	def on_submit(self):
		...
		frappe.enqueue("nrp_manufacturing.nrp_manufacturing.doctype.stock_gl_queue.stock_gl_queue.process_single_stock_gl_queue",doc_name=self.name,doctype=self.doctype,queue="gl",enqueue_after_commit=True)
