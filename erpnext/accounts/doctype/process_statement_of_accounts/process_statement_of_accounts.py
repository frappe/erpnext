...
@frappe.whitelist()
def fetch_customers(customer_collection: str, collection_name: str, primary_mandatory: str):
	customer_list = []
	customers = []
...
@frappe.whitelist()
def get_customer_emails(customer_name: str, primary_mandatory: str, billing_and_primary: bool = True):
