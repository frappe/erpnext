...
class PaymentLedgerEntry(Document):
	...
	def on_update(self):
		...
		if (
			self.against_voucher_type in ["Journal Entry", "Sales Invoice", "Purchase Invoice", "Fees","EME Invoice","Transporter Invoice","Repair And Service Invoice","Coal Raising Invoice","POL Expense"]
