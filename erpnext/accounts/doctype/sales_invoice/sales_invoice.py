...
@frappe.whitelist()
def make_delivery_note(source_name: str, target_doc: str | Document | None = None):
...
@frappe.whitelist()
def make_inter_company_purchase_invoice(source_name: str, target_doc: str | Document | None = None):
