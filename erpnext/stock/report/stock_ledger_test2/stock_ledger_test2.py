					...
					if sle.item_code == product:
						...
						for type in type_transactions:
							...
							if product_register == False:
								...
								"stock_uom":"", "actual_qty":actual_qty_product, "qty_after_transaction":qty_after_transaction_product, "incoming_rate":incoming_rate_product, "valuation_rate":valuation_rate_product, "stock_value":stock_value_product}]
							...
							if actual_type == type:
								...
								if add_transaction:
									# transaction_new = True
									transaction_add.append(sle.voucher_type)
