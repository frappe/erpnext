...
def get_columns():
	columns = [
		...
		{"label": _("Customer's Purchase Order #"),"fieldname": "customer_purchase_order","fieldtype": "Data","width": 210},
		{"label": _("Customer Order #"),"fieldname": "customer_order","fieldtype": "Link","options": "Customer Order","width": 150},
		{"label": _("Product Code"),"fieldname": "item_code","fieldtype": "Data","width": 120},
		{"label": _("Product Name"), "fieldname": "item_name", "width": 350},
		{"label": _("Pack Size"),"fieldname": "pack_size","fieldtype": "Data","width": 100},
		{"label": _("Price (USD)"),"fieldname": "incoming_rate","fieldtype": "Currency","width": 110,"options": "Company:company:default_currency","convertible": "rate"},
		{"label": _("In Qty"),"fieldname": "in_qty","fieldtype": "Float","width": 80,"convertible": "qty","precision": "0"},
		{"label": _("Out Qty"),"fieldname": "out_qty","fieldtype": "Float","width": 80,"convertible": "qty","precision": "0"},
		{"label": _("Batch Qty"),"fieldname": "batch_warehouse_qty","fieldtype": "Float","width": 100,"convertible": "qty","precision": "0"},
		{"label": _("Product Qty"),"fieldname": "qty_after_transaction","fieldtype": "Float","width": 100,"convertible": "qty","precision": "0"},
		...
		{"label": _("Shelf Life"),"fieldname": "shelf_life","fieldtype": "Data","width": 100},
		{"label": _("Shipper Size"),"fieldname": "shipper_size","fieldtype": "Text Editor","width": 110},
		{"label": _("H2K Additional Description"),"fieldname": "additioanl_description","fieldtype": "Text Editor","width": 250},
		{"label": _("Warehouse"),"fieldname": "warehouse","fieldtype": "Data","width": 150},
		{"label": _("Type Of Packing"),"fieldname": "type_of_packing","fieldtype": "Data","width": 150},
		{"label": _("Physical Parameter"),"fieldname": "physical_parameter","fieldtype": "Data","width": 200},
		{"label": _("Barcode"),"fieldname": "barcode","fieldtype": "Data","width": 150},
		{"label": _("Brand"),"fieldname": "brand","fieldtype": "Data","options": "Brand","width": 100},
		{"label": _("Color Band"),"fieldname": "color_band","fieldtype": "Data","width": 100},
		{"label": _("Dossiers"),"fieldname": "dossiers","fieldtype": "Data","width": 100},
		{"label": _("OTC"),"fieldname": "otc_product","fieldtype": "Select","width": 80},
		{"label": _("Pharmacopeia "),"fieldname": "pharmacopeia_data","fieldtype": "Data","width": 120},
		# {"label": _("Label"),"fieldname": "product_label","fieldtype": "Data","width": 100},
		...
		# {"label": _("Document Type / Document No"),"fieldname": "voucher_no","fieldtype": "Dynamic Link","options": "voucher_type","width": 100 },
