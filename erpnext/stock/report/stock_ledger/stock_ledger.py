...
def get_warehouse_condition(warehouse):
	...
	if warehouse_details:
		frappe.log_error("select name from `tabWarehouse` wh where wh.lft >= %s and wh.rgt <= %s and wh.name = '%s'"%(warehouse_details.lft,
			warehouse_details.rgt, warehouse))
		return "select name from `tabWarehouse` wh where wh.lft >= %s and wh.rgt <= %s and wh.name = '%s'"%(warehouse_details.lft,
			warehouse_details.rgt, warehouse)
	return ''
