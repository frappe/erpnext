...
class update_entries_after:
	...
	def update_serial_batch_no_valuation(self, sle, doc, prev_sle=None):
		...
		for d in sabb_data:
			incoming_rate = get_incoming_rate_for_serial_and_batch(self.item_code, self.company, d, sn_obj)
...
def get_incoming_rate_for_serial_and_batch(item_code, company, row, sn_obj):
	if row.serial_no:
