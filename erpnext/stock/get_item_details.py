...
def get_item_tax_info(
	...
	tax_category: str,
	item_codes: str,
	item_rates: str | None = None,
	item_tax_templates: str | None = None,
):
	out = {}
...
@frappe.whitelist()
def get_batch_based_item_price(pctx: ItemPriceCtx | dict | str, item_code: str) -> float:
...
@frappe.whitelist()
def get_conversion_factor(item_code: str, uom: str):
...
@frappe.whitelist()
def get_bin_details(
	item_code: str, warehouse: str, company: str | None = None, include_child_warehouses: bool = False
):
...
@frappe.whitelist()
def get_serial_no(_args: str, serial_nos: str | None = None, sales_order: str | None = None):
