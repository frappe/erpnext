	...
	if frappe.db.get_value("Price List", args.price_list, "currency", cache=True) == args.currency \
		...
		if frappe.has_permission("Item Price", "write"):
			...
			item_price = frappe.db.get_value('Item Price',
				...
				['name', 'price_list_rate', 'update_existing_price_list_rate'], as_dict=1)
			if item_price and item_price.name:
				if item_price.price_list_rate != price_list_rate and item_price.update_existing_price_list_rate:
