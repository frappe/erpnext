...
class Item(WebsiteGenerator):
	...
	def validate_attributes_in_variants(self):
		...
		error_description = _('The following attributes exist in variants but not in the template. You can either delete the attribute from the items or add the attribute to template.')
