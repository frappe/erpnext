...
def ensure_dimension_fields_on_lcv_charges(dimensions):
	...
	for name in dimensions:
		if not frappe.db.exists("Accounting Dimension", name):
			frappe.get_doc({"doctype": "Accounting Dimension", "document_type": name}).insert(
...
class TestLandedCostVoucherAccountingDimensions(FrappeTestCase):
	def setUp(self):
