...
def on_doctype_update():
	frappe.db.add_unique("Stock Level", ["item_code", "warehouse"], constraint_name="unique_item_warehouse")
...
def update_qty(bin_name, args):
	...
	# Standard Cost items are not reposted on backdated entries, so the Stock Level's stock value is not
	...
	frappe.db.set_value("Stock Level", bin_name, bin_values, update_modified=True)
