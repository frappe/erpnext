frappe.pages["welcome-to-erpnext"].on_page_load = function (wrapper) {
	...
	parent.find(".video-placeholder").on("click", function () {
		...
		parent
			...
			.append(
				'<iframe class="embed-responsive-item video-playlist" src="https://www.youtube.com/embed/videoseries?list=PL3lFfCEoMxvxDHtYyQFJeUYkWzQpXwFM9&color=white&autoplay=1&enablejsapi=1" allowfullscreen></iframe>'
			);
	});
