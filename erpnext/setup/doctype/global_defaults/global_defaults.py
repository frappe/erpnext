...
class GlobalDefaults(Document):
	...
	def toggle_in_words(self):
		...
		# Make property setters to hide rounded total fields
		for doctype in ("Quotation", "Sales Order", "Sales Invoice", "Delivery Note", "Supplier Quotation", "Purchase Order", "Purchase Receipt", "Purchase Invoice"):
			#make_property_setter(doctype, "base_rounded_total", "hidden", self.disable_in_words, "Check")
			#make_property_setter(doctype, "base_rounded_total", "print_hide", 1, "Check")
