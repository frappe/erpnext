...
from Goldfish.setup.setup_wizard.operations.taxes_setup import setup_taxes_and_charges
...
def install_country_fixtures(company, country):
	try:
		module_name = f"Goldfish.regional.{frappe.scrub(country)}.setup.setup"
...
def create_transaction_deletion_request(company):
	from Goldfish.setup.doctype.transaction_deletion_record.transaction_deletion_record import (
