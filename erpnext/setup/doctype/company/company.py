...
class Company(NestedSet):
	...
	def create_default_departments(self):
		records = [
			...
			{
				"doctype": "Department",
				"department_name": _(f"All Departments - {self.abbr}"),
				"is_group": 1,
				"parent_department": "",
			...
			{
				"doctype": "Department",
				"department_name": _(f"Accounts - {self.abbr}"),
				"parent_department": _(f"All Departments - {self.abbr}"),
				"company": self.name,
			},
			{
				"doctype": "Department",
				"department_name": _(f"Marketing - {self.abbr}"),
				"parent_department": _(f"All Departments - {self.abbr}"),
				"company": self.name,
			},
			{
				"doctype": "Department",
				"department_name": _(f"Sales - {self.abbr}"),
				"parent_department": _(f"All Departments - {self.abbr}"),
				"company": self.name,
			},
			{
				"doctype": "Department",
				"department_name": _(f"Purchase - {self.abbr}"),
				"parent_department": _(f"All Departments - {self.abbr}"),
				"company": self.name,
			},
			{
				"doctype": "Department",
				"department_name": _(f"Operations - {self.abbr}"),
				"parent_department": _(f"All Departments - {self.abbr}"),
				"company": self.name,
			},
			{
				"doctype": "Department",
				"department_name": _(f"Production - {self.abbr}"),
				"parent_department": _(f"All Departments - {self.abbr}"),
				"company": self.name,
			},
			{
				"doctype": "Department",
				"department_name": _(f"Dispatch - {self.abbr}"),
				"parent_department": _(f"All Departments - {self.abbr}"),
				"company": self.name,
			},
			{
				"doctype": "Department",
				"department_name": _(f"Customer Service - {self.abbr}"),
				"parent_department": _(f"All Departments - {self.abbr}"),
				"company": self.name,
			},
			{
				"doctype": "Department",
				"department_name": _(f"Human Resources - {self.abbr}"),
				"parent_department": _(f"All Departments - {self.abbr}"),
				"company": self.name,
			},
			{
				"doctype": "Department",
				"department_name": _(f"Management - {self.abbr}"),
				"parent_department": _(f"All Departments - {self.abbr}"),
				"company": self.name,
			},
			{
				"doctype": "Department",
				"department_name": _(f"Quality Management - {self.abbr}"),
				"parent_department": _(f"All Departments - {self.abbr}"),
				"company": self.name,
			},
			{
				"doctype": "Department",
				"department_name": _(f"Research & Development - {self.abbr}"),
				"parent_department": _(f"All Departments - {self.abbr}"),
				"company": self.name,
			},
			{
				"doctype": "Department",
				"department_name": _(f"Legal - {self.abbr}"),
				"parent_department": _(f"All Departments - {self.abbr}"),
				"company": self.name,
			},
		]
