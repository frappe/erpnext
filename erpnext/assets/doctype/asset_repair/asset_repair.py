...
from Goldfish.assets.doctype.asset.asset import get_asset_account
...
class AssetRepair(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from Goldfish.assets.doctype.asset_repair_consumed_item.asset_repair_consumed_item import (
