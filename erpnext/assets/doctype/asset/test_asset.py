...
class TestDepreciationMethods(AssetSetup):
	...
	def test_daily_prorata_based_sl_schedule_for_existing_asset_spreads_remaining_value_with_total_days(
		self,
	):
		frappe.db.set_single_value("Accounts Settings", "calculate_depr_using_total_days", 1)
		self.addCleanup(frappe.db.set_single_value, "Accounts Settings", "calculate_depr_using_total_days", 0)
