...
class TestAssetValueAdjustment(unittest.TestCase):
	...
	def test_depreciation_after_cancelling_asset_repair(self):
		...
		expected_gle = (
			("_Test Difference Account - _TC", 4875.29, 0.0),
			("_Test Fixed Asset - _TC", 0.0, 4875.29),
		)
		...
		expected_schedules = [
			...
			["2023-06-30", 9983.33, 55391.38],
			["2023-07-31", 9983.33, 65374.71],
			["2023-08-31", 8258.33, 73633.04],
			["2023-09-30", 8258.33, 81891.37],
			["2023-10-31", 8258.33, 90149.7],
			["2023-11-30", 8258.33, 98408.03],
			["2023-12-31", 8258.33, 106666.36],
			["2024-01-15", 8258.35, 114924.71],
		]
