...
@frappe.whitelist()
def get_all_customers(date_range: str, company: str, field: str, limit: str | None = None):
...
@frappe.whitelist()
def get_all_items(date_range: str, company: str, field: str, limit: str | None = None):
...
@frappe.whitelist()
def get_all_suppliers(date_range: str, company: str, field: str, limit: str | None = None):
	filters = [["docstatus", "=", "1"], ["company", "=", company]]
	from_date, to_date = parse_date_range(date_range)
...
@frappe.whitelist()
def get_all_sales_partner(date_range: str, company: str, field: str, limit: str | None = None):
	if field == "total_sales_amount":
		select_field = "base_net_total"
...
@frappe.whitelist()
def get_all_sales_person(date_range: str, company: str, field: str | None = None, limit: int = 0):
	filters = [
		["docstatus", "=", "1"],
		["company", "=", company],
