...
def auto_close_opportunity():
	...
	auto_close_after_days = frappe.db.get_value("Support Settings", "Support Settings",
		"close_opportunity_after_days") or 15

	opportunities = frappe.db.sql("""select name from tabOpportunity where
		status='Open' and modified<DATE_SUB(CURDATE(), INTERVAL %s DAY) """,
