...
from Goldfish.accounts.party import set_taxes
...
from Goldfish.selling.doctype.customer.customer import parse_full_name
...
def get_lead_details(lead, posting_date=None, company=None):
	...
	from Goldfish.accounts.party import set_address_details
