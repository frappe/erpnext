...
var disable_template = function(frm){
	var doc = frm.doc;
	frappe.call({
		method: 		"erpnext.medical.doctype.lab_test_template.lab_test_template.disable_enable_test_template",
...
var change_template_code = function(frm,doc){
	var d = new frappe.ui.Dialog({
		...
		var change_test_code_from_template = function(test_code,doc){
			frappe.call({
				"method": "erpnext.medical.doctype.lab_test_template.lab_test_template.change_test_code_from_template",
