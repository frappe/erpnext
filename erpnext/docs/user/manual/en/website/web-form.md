...
<img class="screenshot" alt="Web Form" src="/assets/erpnext_docs/assets/img/website/web-form.png">
...
<img class="screenshot" alt="Web form" src="/assets/erpnext_docs/assets/img/website/web-form-view.png">
