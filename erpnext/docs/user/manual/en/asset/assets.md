...
<img class="screenshot" alt="Asset Category" src="/assets/erpnext_docs/assets/img/asset/asset-category.png">
...
<img class="screenshot" alt="Asset" src="/assets/erpnext_docs/assets/img/asset/asset.png">

Explanation of the fields:

1. Item Code: An Item for the Asset must be a non-stock item, with "Is Asset" field checked.

	<img class="screenshot" alt="Asset Item" src="/assets/erpnext_docs/assets/img/asset/asset-item.png">
...
<img class="screenshot" alt="Asset" src="/assets/erpnext_docs/assets/img/asset/depreciation-schedule.png">
...
<img class="screenshot" alt="Asset" src="/assets/erpnext_docs/assets/img/asset/depreciation-entry.png">
...
<img class="screenshot" alt="Asset" src="/assets/erpnext_docs/assets/img/asset/asset-graph.png">
...
<img class="screenshot" alt="Asset" src="/assets/erpnext_docs/assets/img/asset/asset-purchase-invoice.png">
...
<img class="screenshot" alt="Asset" src="/assets/erpnext_docs/assets/img/asset/asset-sales.png">
...
<img class="screenshot" alt="Asset" src="/assets/erpnext_docs/assets/img/asset/scrap-journal-entry.png">

## Asset Movement

The movement of the assets (from one warehouse to another) is also tracked via Asset Movement form.

<img class="screenshot" alt="Asset" src="/assets/erpnext_docs/assets/img/asset/asset-movement.png">

There is also a dedicated button "Transfer Asset" inside the Asset form to track the Asset Movement.

<img class="screenshot" alt="Asset" src="/assets/erpnext_docs/assets/img/asset/asset-movement-using-button.png">
