...
<img alt="Doctype Basic" class="screenshot" src="/assets/erpnext_docs/assets/img/setup/customize/doctype-basics.png">
...
<img alt="Doc fields" class="screenshot" src="/assets/erpnext_docs/assets/img/setup/customize/Doctype-all-fields.png">
...
<img alt="Doctype Naming" class="screenshot" src="/assets/erpnext_docs/assets/img/setup/customize/doctype-field-naming.png">

#### Permission

In this table, you should select roles and define permission roles for them for this Doctype.

<img alt="Doctype Permissions" class="screenshot" src="/assets/erpnext_docs/assets/img/setup/customize/Doctype-permissions.png">

#### Save DocType

On saving doctype, you will get pop-up to provide name for this Doctype.

<img alt="Doctype Save" class="screenshot" src="/assets/erpnext_docs/assets/img/setup/customize/Doctype-save.png">
...
<img alt="Doctype List" class="screenshot" src="/assets/erpnext_docs/assets/img/setup/customize/Doctype-list-view.png">

#### Book master

Using the fields entered, following is the master one book.

<img alt="Doctype Form" class="screenshot" src="/assets/erpnext_docs/assets/img/setup/customize/Doctype-book-added.png">
