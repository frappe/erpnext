...
<img alt="Sort Order field" class="screenshot" src="/assets/erpnext_docs/assets/img/articles/sort-order-2.png">

####Step 3: Update Sort Details

In the Customize Form, you will find these fields.

<img alt="Sort Order field" class="screenshot" src="/assets/erpnext_docs/assets/img/articles/sort-order-1.png">
