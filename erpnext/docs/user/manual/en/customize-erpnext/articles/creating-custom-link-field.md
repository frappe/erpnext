...
<img alt="Select Docytpe" class="screenshot" src="/assets/erpnext_docs/assets/img/articles/link-field-1.gif">
...
<img alt="Enter Values" class="screenshot" src="/assets/erpnext_docs/assets/img/articles/link-field-2.png">
