...
![Request For Quotation](/assets/erpnext_docs/assets/img/buying/make-supplier-quotation-from-rfq.png)

__Step 2:__ Select supplier and click on make Supplier Quotation.

![Request For Quotation](/assets/erpnext_docs/assets/img/buying/supplier-selection-from-rfq.png)

__Step 3:__ System will open the Supplier Quotation, user has to enter the rate and submit it.

![Request For Quotation](/assets/erpnext_docs/assets/img/buying/supplier-quotation-from-rfq.png)

#### For Supplier

__Step 1:__ User has to create contact or enter Email Address against the supplier on Request for Quotation.

![Request For Quotation](/assets/erpnext_docs/assets/img/buying/set-email-id.png)
...
![Request For Quotation](/assets/erpnext_docs/assets/img/buying/supplier-password-update-link.png)
...
![Request For Quotation](/assets/erpnext_docs/assets/img/buying/send-rfq-link.png)

__Step 3:__ Supplier has to enter amount and notes(payment terms) on the form and click on submit

![Request For Quotation](/assets/erpnext_docs/assets/img/buying/supplier-portal-rfq.png)
...
![Request For Quotation](/assets/erpnext_docs/assets/img/buying/request-for-quotation.gif)
