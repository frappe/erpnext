...
### For Page
<img alt="Assign roles to the page" class="screenshot" src="/assets/erpnext_docs/assets/img/users-and-permissions/roles-for-page.png">

### For Report
<img alt="Assign roles to the report" class="screenshot" src="/assets/erpnext_docs/assets/img/users-and-permissions/roles-for-report.png">
...
<img alt="Tools to assign custom roles to the page" class="screenshot" src="/assets/erpnext_docs/assets/img/users-and-permissions/role-permission-for-page-and-report.png">
...
<img alt="Reset the default roles" class="screenshot" src="/assets/erpnext_docs/assets/img/users-and-permissions/reset-roles-permisison-for-page-report.png">
