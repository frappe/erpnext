...
<img alt="Manage Read, Write, Create, Submit, Amend access using the Role Permissions Manager" class="screenshot" src="/assets/erpnext_docs/assets/img/users-and-permissions/setting-up-permissions-leave-application.png">
...
<img class="screenshot" alt="Leave Application Form should be created by an Employee, and approved by Leave Approver or HR User" src="/assets/erpnext_docs/assets/img/users-and-permissions/setting-up-permissions-leave-application-form.png">

   1. **It should be created by an Employee.**
     For this, Employee Role should be given Read, Write, Create permissions.

<img class="screenshot" alt="Giving Read, Write and Create Permissions to Employee for Leave Application"  src="/assets/erpnext_docs/assets/img/users-and-permissions/setting-up-permissions-employee-role.png">
...
<img class="screenshot" alt="Giving Submit and Cancel permissions to HR Manager for Leave Applications. 'Apply User Permissions' is unchecked to give full access." src="/assets/erpnext_docs/assets/img/users-and-permissions/setting-up-permissions-hr-manager-role.png">
...
<img class="screenshot" alt="Giving Read, Write and Submit permissions to Leave Approver for Leave Applications.'Apply User Permissions' is checked to limit access based on Employee." src="/assets/erpnext_docs/assets/img/users-and-permissions/setting-up-permissions-leave-approver-role.png">
...
<img class="screenshot" alt="Let HR User delegate access to Leave Applications by checking 'Set User Permissions'. This will allow HR User to access User Permissions Manager for 'Leave Application'" src="/assets/erpnext_docs/assets/img/users-and-permissions/setting-up-permissions-hr-user-role.png">
