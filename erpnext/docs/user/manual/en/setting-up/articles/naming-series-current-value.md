...
<img alt="Update Series Section" class="screenshot" src="/assets/erpnext_docs/assets/img/articles/current-no-1.png">

#### Select Prefix

Considering our scenario, prefix for Sales Order will be "SO".

<img alt="Series Prefix" class="screenshot" src="/assets/erpnext_docs/assets/img/articles/current-no-2.png">
...
<img alt="Series Current Value" class="screenshot" src="/assets/erpnext_docs/assets/img/articles/current-no-3.png">
