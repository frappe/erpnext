...
<img class="screenshot" alt="SMS Setting 2" src="/assets/erpnext_docs/assets/img/setup/sms-settings2.jpg">
...
<img class="screenshot" alt="SMS Setting" src="/assets/erpnext_docs/assets/img/setup/sms-settings1.png">
