...
<img class="screenshot" alt="LDAP Settings" src="/assets/erpnext_docs/assets/img/setup/integrations/ldap_settings.png">


After setting up LDAP parameters, on login screen, the system enables **Login Via LDAP** option.

<img class="screenshot" alt="LOGIN via LDAP" src="/assets/erpnext_docs/assets/img/setup/integrations/login_via_ldap.png">
