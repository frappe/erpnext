...
You can setup several Braintree payment gateways if needed.
The choice of payment gateway account will determine which braintree account is used for the payment.

<img class="screenshot" alt="Braintree Settings" src="/docs/assets/img/setup/integrations/braintree_account.png">
...
<img class="screenshot" alt="Braintree COA" src="/docs/assets/img/setup/integrations/braintree_coa.png">
...
<img class="screenshot" alt="Payment Gateway Account" src="/docs/assets/img/setup/integrations/payment_gateway_account_braintree.png">
