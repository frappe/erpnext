...
<img class="screenshot" alt="Razorpay Settings" src="/assets/erpnext_docs/assets/img/setup/integrations/stripe_setting.png">
...
<img class="screenshot" alt="Stripe COA" src="/assets/erpnext_docs/assets/img/setup/integrations/stripe_coa.png">

Also it will create Payment Gateway Account entry. Payment Gateway Account is configuration hub from this you can set account head from existing COA, default Payment Request email body template.

<img class="screenshot" alt="Payment Gateway Account" src="/assets/erpnext_docs/assets/img/setup/integrations/payment_gateway_account_stripe.png">
