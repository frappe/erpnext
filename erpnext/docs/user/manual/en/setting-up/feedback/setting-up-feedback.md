...
<img class="screenshot" alt="Setting Subject" src="/assets/erpnext_docs/assets/img/setup/feedback/feedback-trigger-subject.png">
...
<img class="screenshot" alt="Setting Condition" src="/assets/erpnext_docs/assets/img/setup/feedback/feedback-trigger-condition.png">
...
1. Setting up Feedback Trigger
    <img class="screenshot" alt="Defining Criteria" src="/assets/erpnext_docs/assets/img/setup/feedback/setting-up-feedback-trigger.png">

1. Setting the Recipients and Message
    <img class="screenshot" alt="Set Message" src="/assets/erpnext_docs/assets/img/setup/feedback/setting-up-feedback-trigger-message.png">
