...
<img class="screenshot" alt="Send Email" src="/assets/erpnext_docs/assets/img/setup/print/print-format-builder-1.gif">
...
<img class="screenshot" alt="Send Email" src="/assets/erpnext_docs/assets/img/setup/print/print-format-builder-2.gif">

### Step 3

To remove a field, just drag it back into the fields sidebar.

<img class="screenshot" alt="Send Email" src="/assets/erpnext_docs/assets/img/setup/print/print-format-builder-3.gif">
...
<img class="screenshot" alt="Send Email" src="/assets/erpnext_docs/assets/img/setup/print/print-format-builder-4.gif">
