...
<img class="screenshot" alt="Defining Criteria" src="/assets/erpnext_docs/assets/img/setup/email/email-account-list.png">
...
<img class="screenshot" alt="Outgoing EMail" src="/assets/erpnext_docs/assets/img/setup/email/email-account-sending.png">
...
<img class="screenshot" alt="Incoming EMail" src="/assets/erpnext_docs/assets/img/setup/email/email-account-incoming.png">
...
<img class="screenshot" alt="Incoming EMail Conditions" src="/assets/erpnext_docs/assets/img/setup/email/email-account-incoming-conditions.png">
...
<img class="screenshot" alt="Incoming EMail" src="/assets/erpnext_docs/assets/img/setup/email/email-account-unreplied.png">
