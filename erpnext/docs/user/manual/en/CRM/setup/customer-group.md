...
<img class="screenshot" alt="Customer Group Tree" src="/assets/erpnext_docs/assets/img/crm/customer-group-tree.png">
...
<img class="screenshot" alt="Customer Group report" src="/assets/erpnext_docs/assets/img/crm/sales-analytics-customer.gif">
