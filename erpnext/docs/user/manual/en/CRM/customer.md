...
<img class="screenshot" alt="Create Customer" src="/assets/erpnext_docs/assets/img/crm/create-customer.gif">
...
<img class="screenshot" alt="Customer" src="/assets/erpnext_docs/assets/img/crm/customer-to selling-flowchart.jpeg">
