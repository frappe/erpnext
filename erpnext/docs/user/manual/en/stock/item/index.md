...
<img alt="Serial No modal" class="screenshot" src="/assets/erpnext_docs/assets/img/stock/serial_no_modal.gif"><img alt="Batch No modal" class="screenshot" src="/assets/erpnext_docs/assets/img/stock/batch_no_modal.png">
...
<img alt="Item Purchase Details" class="screenshot" src="/assets/erpnext_docs/assets/img/stock/item-purchase.png">

<img class="screenshot" alt="Purchase details" src="/assets/erpnext_docs/assets/img/stock/item-purchase.png">
...
<img alt="Item Supplier Details" class="screenshot" src="/assets/erpnext_docs/assets/img/stock/item-supplier.png">
...
<img alt="Item Sales Details" class="screenshot" src="/assets/erpnext_docs/assets/img/stock/item-sales.png">

* **Default Income Account:** Income account selected here will be fetched automatically in sales invoice for this item.

<img class="screenshot" alt="Sales details" src="/assets/erpnext_docs/assets/img/stock/item-sales.png)">
...
<img class="screenshot" alt="Manufaturing details" src="/assets/erpnext_docs/assets/img/stock/item-manufacturing-website.png">
