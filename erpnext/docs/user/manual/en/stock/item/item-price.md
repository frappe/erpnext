...
![Item Price list](/docs/assets/img/stock/item-price-1.png)
...
![Item Price Item](/docs/assetsimg/stock/item-price-2.png)

Step 3: Enter Rate

Enter selling/buying rate of an item in Price List currency.

![Item Price Rate](/docs/assets/img/stock/item-price-3.png)
