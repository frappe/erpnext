...
<img alt="Material Transfer" class="screenshot" src="/assets/erpnext_docs/assets/img/articles/barcode-item-master.png">
...
<img alt="Material Transfer" class="screenshot" src="/assets/erpnext_docs/assets/img/articles/barcode-item-selection.gif">
