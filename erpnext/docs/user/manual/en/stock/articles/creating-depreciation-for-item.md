...
<img alt="reorder level" class="screenshot" src="/assets/erpnext_docs/assets/img/articles/fixed-asset-dep-1.gif">
...
<img alt="reorder level" class="screenshot" src="/assets/erpnext_docs/assets/img/articles/fixed-asset-dep-2.png">
