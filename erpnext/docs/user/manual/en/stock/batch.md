...
<img class="screenshot" alt="Item Setup for Batches" src="/assets/erpnext_docs/assets/img/stock/item_setup_for_batch.png">
...
<img class="screenshot" alt="Batch View" src="/assets/erpnext_docs/assets/img/stock/batch_view.png">
