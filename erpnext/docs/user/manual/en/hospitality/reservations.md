...
<img class="screenshot" alt="Reservation" src="/assets/erpnext_docs/assets/img/restaurant/reservation.png">

### Kanban

As your guests walk in, You can also manage the reservations by making a simple Kanban board for the same.

<img class="screenshot" alt="Reservation Kanban Board" src="/assets/erpnext_docs/assets/img/restaurant/reservation-kanban.png">
