...
<img class="screenshot" alt="Delete a Docuemnt" src="/assets/erpnext_docs/assets/img/collaboration-tools/delete-a-doc.png">
...
<img class="screenshot" alt="Deleted Docs List" src="/assets/erpnext_docs/assets/img/collaboration-tools/deleted-docs-list.gif">

####Step 2: Open Doc and Restore

Open the document to be restored from the list. Click on Restore button.

<img class="screenshot" alt="Restored Doc" src="/assets/erpnext_docs/assets/img/collaboration-tools/restore-a-doc.png">

####Step 3: Restored

Once a document is restored, you will be able to use it for creating entries in your ERPNext account. 

<img class="screenshot" alt="Restored Doc" src="/assets/erpnext_docs/assets/img/collaboration-tools/restored-doc.png">
