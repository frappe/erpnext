...
<img class="screenshot" alt="Appraisal" src="/assets/erpnext_docs/assets/img/human-resources/appraisal.png">

After you select the template, the remaining form appears.

#### Step 2: Enter Employee Details

<img class="screenshot" alt="Appraisal" src="/assets/erpnext_docs/assets/img/human-resources/appraisal-employee.png">
