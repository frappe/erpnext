...
<img class="screenshot" alt="Expense Claim" src="/assets/erpnext_docs/assets/img/human-resources/expense_claim.png">
...
<img class="screenshot" alt="Expense Claim" src="/assets/erpnext_docs/assets/img/human-resources/employee_account.png">
...
<img class="screenshot" alt="Expense Claim" src="/assets/erpnext_docs/assets/img/human-resources/expense_claim_book.png">

User can view unpaid expense claim using report "Unclaimed Expense Claims"
<img class="screenshot" alt="Expense Claim" src="/assets/erpnext_docs/assets/img/human-resources/unclaimed_expense_claims.png">

### Payment for Expense Claim

To make payment against the expense claim, user has to click on Make > Bank Entry
#### Expense Claim
<img class="screenshot" alt="Expense Claim" src="/assets/erpnext_docs/assets/img/human-resources/payment.png">
...
<img class="screenshot" alt="Expense Claim - Project Link" src="/assets/erpnext_docs/assets/img/project/project_expense_claim_link.png">
