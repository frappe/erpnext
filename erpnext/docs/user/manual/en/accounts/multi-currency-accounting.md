...
<img class="screenshot" alt="Set Currency from Chart of Accounts"  	src="/assets/erpnext_docs/assets/img/accounts/multi-currency/chart-of-accounts.png">

You can also assign / modify the currency by opening specific Account record for existing Accounts.

<img class="screenshot" alt="Modify Account Currency"  	src="/assets/erpnext_docs/assets/img/accounts/multi-currency/account.png">
...
<img class="screenshot" alt="Customer Accounting Currency"  	src="/assets/erpnext_docs/assets/img/accounts/multi-currency/customer.png">
...
<img class="screenshot" alt="Sales Invoice Outstanding"  	src="/assets/erpnext_docs/assets/img/accounts/multi-currency/sales-invoice.png">
...
<img class="screenshot" alt="Journal Entry Exchange Rate"  	src="/assets/erpnext_docs/assets/img/accounts/multi-currency/journal-entry-multi-currency.png">
...
<img class="screenshot" alt="Journal Entry in multi currency"  	src="/assets/erpnext_docs/assets/img/accounts/multi-currency/journal-entry-row.png">
...
<img class="screenshot" alt="General Ledger Report"  	src="/assets/erpnext_docs/assets/img/accounts/multi-currency/general-ledger.png">

### Accounts Receivable / Payable

In Accounts Receivable / Payable report, system shows all the amounts in Party / Account Currency.

<img class="screenshot" alt="Accounts Receivable Report"  	src="/assets/erpnext_docs/assets/img/accounts/multi-currency/accounts-receivable.png">
