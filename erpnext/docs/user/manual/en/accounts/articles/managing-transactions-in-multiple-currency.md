...
<img alt="Accounts Frozen Date" class="screenshot" src="/assets/erpnext_docs/assets/img/articles/multiple-currency-1.gif">
...
<img alt="Accounts Frozen Date" class="screenshot" src="/assets/erpnext_docs/assets/img/articles/multiple-currency-2.png">
