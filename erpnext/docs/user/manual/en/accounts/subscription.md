...
<img class="screenshot" alt="Subscription" src="/assets/erpnext_docs/assets/img/accounts/subscription.png">
...
<img class="screenshot" alt="Subscription" src="/assets/erpnext_docs/assets/img/accounts/subscription.gif">
