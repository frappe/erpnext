...
<img alt="Adding Margin in Pricing Rule" class="screenshot"  src="/assets/erpnext_docs/assets/img/selling/margin-pricing-rule.png">
...
<img alt="Adding Margin in Pricing Rule" class="screenshot"  src="/assets/erpnext_docs/assets/img/selling/margin-item-price-list.png">
...
<img alt="Adding Margin in Quotation" class="screenshot"  src="/assets/erpnext_docs/assets/img/selling/margin-quotation-item.png">
