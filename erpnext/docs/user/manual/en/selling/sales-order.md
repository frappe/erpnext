...
<img class="screenshot" alt="Sales Order flow" src="/assets/erpnext_docs/assets/img/selling/sales-order-f.jpg">
...
<img class="screenshot" alt="Make Sales Order from Quotation" src="/assets/erpnext_docs/assets/img/selling/make-SO-from-quote.png">

Or you can create a new Sales Order and pull details from an Quotation.

<img class="screenshot" alt="Make Sales Order from Quotation" src="/assets/erpnext_docs/assets/img/selling/make-so.gif">
...
<img class="screenshot" alt="Reccuring Sales Order" src="/assets/erpnext_docs/assets/img/selling/recurring-sales-order.png">
