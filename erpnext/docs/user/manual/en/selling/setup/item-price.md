...
+<img class="screenshot" alt="Item Price list" src="/assets/erpnext_docs/assets/img/stock/item-price-1.png">
...
+<img class="screenshot" alt="Item Price list" src="/assets/erpnext_docs/assets/img/stock/item-price-2.png">

Step 3: Enter Rate

Enter selling/buying rate of an item in Price List currency.

+<img class="screenshot" alt="Item Price list" src="/assets/erpnext_docs/assets/img/stock/item-price-3.png">
