...
<img class="screenshot" alt="Baumstruktur Artikelgruppe" src="/assets/erpnext_docs/assets/img/stock/item-group-tree.png">
...
<img class="screenshot" alt="Artikelgruppe hinzufügen" src="/assets/erpnext_docs/assets/img/stock/item-group-new.gif">

### Eine Artikelgruppe löschen
* Wählen Sie die zu löschende Artikelgruppe aus.
* Klicken Sie auf "Löschen"

<img class="screenshot" alt="Artikelgruppe hinzufügen" src="/assets/erpnext_docs/assets/img/stock/item-group-del.gif">
