...
<img class="screenshot" alt="SMS-Einstellungen" src="/assets/erpnext_docs/assets/img/setup/sms-settings2.jpg">
...
<img class="screenshot" alt="SMS-Einstellungen" src="/assets/erpnext_docs/assets/img/setup/sms-settings1.png">
