...
![Grundlagen zum Doctype](/assets/erpnext_docs/assets/img/setup/customize/doctype-basics.png)
...
![Felder im DocType](/assets/erpnext_docs/assets/img/setup/customize/Doctype-all-fields.png)
...
![Bezeichnung von DocTypes](/assets/erpnext_docs/assets/img/setup/customize/doctype-field-naming.png)

### Berechtigung

In dieser Tabelle können Sie Rollen und Berechtigungs-Rollen für diese für die betreffenden DocTypes auswählen.

![Berechtigungen bei DocTypes](/assets/erpnext_docs/assets/img/setup/customize/Doctype-permissions.png)
...
![DocTypes speichern](/assets/erpnext_docs/assets/img/setup/customize/Doctype-save.png)
...
![Übersicht der DocTypes](/assets/erpnext_docs/assets/img/setup/customize/Doctype-list-view.png)

### Buchvorlage

Wenn Sie die Felder ausfüllen, schaut das ganze dann so aus.

![Übersicht der DocTypes](/assets/erpnext_docs/assets/img/setup/customize/Doctype-book-added.png)
