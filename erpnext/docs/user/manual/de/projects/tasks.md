...
<img class="screenshot" alt="Aufgabe" src="/assets/erpnext_docs/assets/img/project/task.png">

### Status der Aufgabe

Ein Aufgabe kann folgende Stati haben: "Offen", "In Arbeit", "Wartet auf Überprüfung", "Geschlossen" und "Abgebrochen".

<img class="screenshot" alt="Aufgabe - Status" src="/assets/erpnext_docs/assets/img/project/task_status.png">
...
<img class="screenshot" alt="Anhängigkeiten" src="/assets/erpnext_docs/assets/img/project/task_depends_on.png">
...
<img class="screenshot" alt="Aufgabe - Zeitprotokoll ansehen" src="/assets/erpnext_docs/assets/img/project/task_view_time_log.png">

<img class="screenshot" alt="Aufgabe - Liste der Zeitprotokolle" src="/assets/erpnext_docs/assets/img/project/task_time_log_list.png">

* Sie können ein Zeitprotokoll auch direkt erstellen und mit einer Aufgabe verknüpfen.

<img class="screenshot" alt="Aufgabe - Zeitprotokoll verknüpfen" src="/assets/erpnext_docs/assets/img/project/task_time_log_link.png">
...
<img class="screenshot" alt="Aufgabe - Aufwandsabrechnung ansehen" src="/assets/erpnext_docs/assets/img/project/task_view_expense_claim.png">

* Sie können eine Aufwandsabrechnung auch direkt erstellen und sie mit einer Aufgabe verknüpfen.

<img class="screenshot" alt="Aufgabe - Aufwandsabrechnung verknüpfen" src="/assets/erpnext_docs/assets/img/project/task_expense_claim_link.png">
...
<img class="screenshot" alt="Aufgabe - Gesamtsumme Aufwandsabrechnung" src="/assets/erpnext_docs/assets/img/project/task_total_expense_claim.png">
