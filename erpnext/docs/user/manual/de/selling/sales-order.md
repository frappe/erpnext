...
<img class="screenshot" alt="Kundenauftrag aus Angebot erstellen" src="/assets/erpnext_docs/assets/img/selling/sales-order-f.jpg">
...
<img class="screenshot" alt="Kundenauftrag aus Angebot erstellen" src="/assets/erpnext_docs/assets/img/selling/make-SO-from-quote.png">

Oder Sie erstellen einen neuen Kundenauftrag und entnehmen die Details aus dem Angebot.

<img class="screenshot" alt="Kundenauftrag aus Angebot erstellen" src="/assets/erpnext_docs/assets/img/selling/make-so.gif">
...
<img class="screenshot" alt="Wiederkehrende Kundenaufträge" src="/assets/erpnext_docs/assets/img/selling/recurring-sales-order.png">
