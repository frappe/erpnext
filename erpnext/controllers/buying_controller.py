...
class BuyingController(StockController):
	...
	def set_missing_values(self, for_validate=False):
		...
		if getattr(self, "supplier", None):
			self.update_if_missing(get_party_details(self.supplier, party_type="Supplier", letter_of_credit=self.get("letter_of_credit"),
				ignore_permissions=self.flags.ignore_permissions, doctype=self.doctype, company=self.company))
