...
status_map = {
	...
	"Material Request": [
		...
		[
			"Returned",
			"eval:self.status != 'Stopped' and self.docstatus == 1 and self.per_returned == 100 and self.material_request_type == 'Purchase'",
		],
		[
			"Partially Returned",
			"eval:self.status != 'Stopped' and self.per_returned > 0 and self.per_returned < 100 and self.docstatus == 1 and self.material_request_type == 'Purchase'",
		],
	],
	"POS Opening Entry": [
		["Draft", None],
