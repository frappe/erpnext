...
status_map = {
	...
	"Sales Order": [
		...
		["To Bill", "eval:(self.per_delivered == 100 or self.skip_delivery_note_creation) and self.per_billed < 100 and self.docstatus == 1"],
		["To Deliver", "eval:self.per_delivered < 100 and self.per_billed == 100 and self.docstatus == 1 and not self.skip_delivery_note_creation"],
		["Completed", "eval:(self.per_delivered == 100 or self.skip_delivery_note_creation) and self.per_billed == 100 and self.docstatus == 1"],
		["Cancelled", "eval:self.docstatus==2"],
		["Closed", "eval:self.status=='Closed'"],
