...
@frappe.whitelist()
def create_variant(item: dict, args: str | dict, use_template_image: bool = False):
...
@frappe.whitelist()
def enqueue_multiple_variant_creation(item: dict, args: str | dict, use_template_image: bool = False):
	use_template_image = frappe.parse_json(use_template_image)
...
@frappe.whitelist()
def create_variant_doc_for_quick_entry(template: str, args: str | dict):
