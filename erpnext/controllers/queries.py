...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def lead_query(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
	doctype = "Lead"
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def tax_account_query(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
	doctype = "Account"
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def bom(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
	doctype = "BOM"
	conditions = []
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def get_project_name(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def get_batch_no(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
	doctype = "Batch"
	meta = frappe.get_meta(doctype, cached=True)
	searchfields = meta.get_search_fields()
	page_len = 300
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def get_account_list(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
	doctype = "Account"
	filter_list = []
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def get_blanket_orders(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def get_income_account(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def get_expense_account(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
	from erpnext.controllers.queries import get_match_cond
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def warehouse_query(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def get_batch_numbers(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def get_purchase_receipts(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
	query = """
		select pr.name
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def get_purchase_invoices(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
	query = """
		select pi.name
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def get_tax_template(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
...
@frappe.whitelist()
@frappe.validate_and_sanitize_search_inputs
def get_item_uom_query(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
