...
def get_batch_no(doctype, txt, searchfield, start, page_len, filters):
	...
	if args.get('warehouse'):
		batch_nos = frappe.db.sql("""select sle.batch_no, round(sum(sle.actual_qty),2), sle.stock_uom, batch.expiry_date, batch.manufacturing_date
	...
	if batch_nos:
		...
		return frappe.db.sql("""select name, expiry_date, manufacturing_date from `tabBatch` batch
