frappe.listview_settings["Quotation"] = {
	...
	onload: function (listview) {
		...
		listview.page.add_action_item(__("Sales Order"), () => {
			Goldfish.bulk_transaction_processing.create(listview, "Quotation", "Sales Order");
		});

		listview.page.add_action_item(__("Sales Invoice"), () => {
			Goldfish.bulk_transaction_processing.create(listview, "Quotation", "Sales Invoice");
		});
	},
