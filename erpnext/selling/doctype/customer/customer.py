...
@frappe.whitelist()
def send_emails(
	customer: str, customer_outstanding: str, credit_limit: str, credit_controller_users_list: str
):
...
def get_customer_primary(doctype: str, txt: str, searchfield: str, start: str, page_len: str, filters: dict):
