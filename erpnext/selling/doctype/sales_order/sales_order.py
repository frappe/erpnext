...
class SalesOrder(SellingController):
	...
	@frappe.whitelist()
	def create_delivery_schedule(self, child_row: str, schedules: str):
...
def make_purchase_order(
	source_name: str, selected_items: str | None = None, target_doc: str | Document | None = None
):
...
@frappe.whitelist()
def make_raw_material_request(items: str, company: str, sales_order: str, project: str | None = None):
	if not frappe.has_permission("Sales Order", "write"):
		frappe.throw(_("Not permitted"), frappe.PermissionError)
