...
def get_opp_by_lead_source(from_date, to_date, company):
	opportunities = frappe.get_all("Opportunity", filters=[['status', 'in', ['Open', 'Quotation', 'Replied']], ['company', '=', company]], fields=['currency', 'sales_stage', 'opportunity_amount', 'probability', 'source'])
...
def get_pipeline_data(from_date, to_date, company):
	opportunities = frappe.get_all("Opportunity", filters=[['status', 'in', ['Open', 'Quotation', 'Replied']], ['company', '=', company]], fields=['currency', 'sales_stage', 'opportunity_amount', 'probability'])
