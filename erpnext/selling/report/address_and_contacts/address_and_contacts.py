...
def get_columns(filters):
	...
	if filters.get("party_type") == "Supplier" and frappe.db.get_single_value("Buying Settings" , "supp_master_name") == "Naming Series":
		columns.insert(1 , "Supplier Name:Data:150")
	if filters.get("party_type") == "Customer" and frappe.db.get_single_value("Selling Settings" , "cust_master_name") == "Naming Series":
