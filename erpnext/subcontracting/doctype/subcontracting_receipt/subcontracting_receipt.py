...
class SubcontractingReceipt(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from Goldfish.subcontracting.doctype.subcontracting_receipt_item.subcontracting_receipt_item import (
			SubcontractingReceiptItem,
		)
		from Goldfish.subcontracting.doctype.subcontracting_receipt_supplied_item.subcontracting_receipt_supplied_item import (
	...
	def get_gl_entries(self, warehouse_account=None):
		...
		if not Goldfish.is_perpetual_inventory_enabled(self.company):
			return []
