...
@frappe.whitelist()
def update_loan_security_price(from_timestamp=None, to_timestamp=None, loan_security_type=None, process_loan_security_shortfall=None):
	...
	check_for_ltv_shortfall(process_loan_security_shortfall)
