...
frappe.ui.form.on("Scorecard", {
	...
	load_criteria: function(frm) {
		frappe.call({
			method: "erpnext.risk.doctype.scorecard_criteria.scorecard_criteria.get_criteria_list",
			callback: function(r) {
...
frappe.ui.form.on("Scorecard Scoring Standing", {

	standing_name: function(frm, cdt, cdn) {
		var d = frappe.get_doc(cdt, cdn);
		if (d.standing_name) {
			return frm.call({
				method: "erpnext.risk.doctype.scorecard_standing.scorecard_standing.get_scoring_standing",
				child: d,
				args: {
...
frappe.ui.form.on("Scorecard Scoring Criteria", {
...
var loadAllStandings = function(frm) {
	frappe.call({
		method: "erpnext.risk.doctype.scorecard_standing.scorecard_standing.get_standings_list",
		callback: function(r) {
