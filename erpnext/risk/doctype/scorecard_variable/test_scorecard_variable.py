...
from erpnext.risk.doctype.scorecard_variable.scorecard_variable import VariablePathNotFound


class TestScorecardVariable(FrappeTestCase):
	def test_variable_exist(self):
		for d in test_existing_variables:
			my_doc = frappe.get_doc("Scorecard Variable", d.get("name"))
