...
import erpnext.risk.doctype.scorecard_variable.scorecard_variable as variable_functions
from erpnext.risk.doctype.scorecard_criteria.scorecard_criteria import get_variables


class ScorecardPeriod(Document):
	def validate(self):
...
def make_scorecard(source_name, target_doc=None):
	...
	doc = get_mapped_doc(
		...
		source_name,
		{
			"Scorecard": {"doctype": "Scorecard Period"},
			"Scorecard Scoring Criteria": {
