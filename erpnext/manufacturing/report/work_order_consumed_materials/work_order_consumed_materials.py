...
def get_fields():
	return ["`tabWork Order Item`.`parent`", "`tabWork Order Item`.`item_code` as raw_material_item_code",
		...
		"`tabWork Order Item`.`serial_no` as transferred_serial_no", "`tabWork Order Item`.`consumed_serial_no`",
		"`tabWork Order Item`.`batch_no` as transferred_batch_no", "`tabWork Order Item`.`consumed_batch_no`",
		"`tabWork Order`.`name`", "`tabWork Order`.`production_item`", "`tabWork Order`.`qty`",
		"`tabWork Order`.`produced_qty`", "`tabWork Order Item`.`source_warehouse`"]
...
def get_columns():
	return [
		...
		{
			"label": _("Transferred Serial No"),
			"fieldname": "transferred_serial_no",
			"fieldtype": "Data",
			"width": 110
		},
		{
			"label": _("Consumed Serial No"),
			"fieldname": "consumed_serial_no",
			"fieldtype": "Data",
			"width": 110
		},
		{
			"label": _("Transferred Batch No"),
			"fieldname": "transferred_batch_no",
			"fieldtype": "Data",
			"width": 110
		},
		{
			"label": _("Consumed Batch No"),
			"fieldname": "consumed_batch_no",
			"fieldtype": "Data",
			"width": 110
		},
	]