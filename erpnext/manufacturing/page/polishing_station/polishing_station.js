frappe.pages['polishing-station'].on_page_load = function (wrapper) {
    let page = frappe.ui.make_app_page({
        parent: wrapper,
        title: 'Polishing Station',
        single_column: true
    });
...
frappe.pages['polishing-station'].on_page_show = (wrapper) => {
    load_vue(wrapper);
};
...
async function load_vue(wrapper) {
    ...
    frappe.queue_station_app = frappe.ui.setup_queue_station($parent, "Polishing");
}
