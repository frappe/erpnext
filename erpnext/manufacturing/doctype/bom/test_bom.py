...
class TestBOM(unittest.TestCase):
	def test_get_items(self):
		...
		items_dict = get_bom_items_as_dict(bom=get_default_bom(), organization="_Test organization", qty=1, fetch_exploded=0)
	...
	def test_get_items_exploded(self):
		from erpnext.manufacturing.doctype.bom.bom import get_bom_items_as_dict
		items_dict = get_bom_items_as_dict(bom=get_default_bom(), organization="_Test organization", qty=1, fetch_exploded=1)
		self.assertTrue(test_records[2]["items"][0]["item_code"] in items_dict)
	...
	def test_get_items_list(self):
		...
		self.assertEquals(len(get_bom_items(bom=get_default_bom(), organization="_Test organization")), 3)
