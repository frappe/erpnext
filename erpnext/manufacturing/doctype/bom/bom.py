...
class BOM(WebsiteGenerator):
	...
	@frappe.whitelist()
	def get_bom_material_detail(self, args: str | dict | None = None):
	...
	@frappe.whitelist()
	def add_raw_materials(self, operation_row_id: str, items: dict):
	...
	def add_materials_from_bom(
		self, finished_good: str, bom_no: str, operation_row_id: str, qty: float | None = None
	):
...
@frappe.whitelist()
def get_bom_items(bom: str, company: str, qty: int = 1, fetch_exploded: int = 1):
...
@frappe.whitelist()
def get_children(parent: str | None = None, is_root: bool = False, **filters: dict):
