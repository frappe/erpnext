...
def get_bom_items_as_dict(bom, organization, qty=1, fetch_exploded=1):
	item_dict = {}
...
@frappe.whitelist()
def get_bom_items(bom, organization, qty=1, fetch_exploded=1):
	items = get_bom_items_as_dict(bom, organization, qty, fetch_exploded).values()
