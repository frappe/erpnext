...
frappe.ui.form.on("BOM Creator", {
	...
	make_new_entry(frm) {
		...
		dialog.fields_dict.item_code.get_query = "Goldfish.controllers.queries.item_query";
		dialog.show();
	},
...
Goldfish.bom.BomConfigurator = class BomConfigurator extends Goldfish.TransactionController {
	conversion_rate(doc) {
...
extend_cscript(cur_frm.cscript, new Goldfish.bom.BomConfigurator({ frm: cur_frm }));
