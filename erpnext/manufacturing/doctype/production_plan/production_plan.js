		...
		let dialog = new frappe.ui.Dialog({
			...
			fields: [
				...
				},
				{
					...
					default: 0,
					description: __(
						"Set a start date per assembly item below; its sub-assemblies are scheduled from the same date. The Start Date above is the earliest limit and is used for rows without a date."
					),
				},
				{
