...
doc_events = {
	...
	'Sales Invoice': {
		'validate': 'erpnext.regional.india.utils.set_place_of_supply_for_sales_invoice'
	},
	'Purchase Invoice': {
		'validate': 'erpnext.regional.india.utils.set_place_of_supply_for_purchase_invoice'
	}
}
