...
doc_events = {
	...
	"Salary Information File": {
		...
		"after_insert": ["erpnext.regional.qatar.utils.validate_bank_details_and_generate_csv", "erpnext.regional.united_arab_emirates.utils.validate_bank_details_and_generate_csv"]
	},
	"Email Unsubscribe": {
