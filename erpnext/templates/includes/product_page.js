...
frappe.ready(function() {
	...
	frappe.call({
		...
		callback: function(r) {
			if(r.message && r.message.is_cart_enabled) {
				$(".item-cart").toggleClass("hide", (!!!r.message.product_info.price || !!!r.message.product_info.in_stock));
			}
			if(r.message && r.message.product_info.price) {
				$(".item-price")
