        ...
        for gle in entries:
                if cstr(gle.against_voucher) == gle.voucher_no or not gle.against_voucher \
                        ...
                        if abs(flt(outstanding_amount)) > 0.01:
                                ...
                                data.append(row)
				row += account_supplier.get(gle.account, ""),account_supplier_type_map.get(gle.account),gle.remarks
		#webnotes.msgprint(data)
	for i in range(0, len(data)):
		#len(data)
		#webnotes.msgprint(data[0])
...
def get_columns():
        return [
                "Posting Date:Date:80", "Account:Link/Account:200", "Voucher Type::110", 
                "Voucher No::120", "::30",
				...
				"Supplier:Link/Supplier:200", "Supplier Type:Link/Supplier Type:120", "Remarks::250"
        ]
