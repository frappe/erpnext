...
from perceptrons.setup.doctype.employee.employee import get_holiday_list_for_employee
from perceptrons.stock.doctype.serial_no.serial_no import get_serial_nos
from perceptrons.utilities.transaction_base import TransactionBase, delete_events
...
class MaintenanceSchedule(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.maintenance.doctype.maintenance_schedule_detail.maintenance_schedule_detail import (
			MaintenanceScheduleDetail,
		)
		from perceptrons.maintenance.doctype.maintenance_schedule_item.maintenance_schedule_item import (
