...
def notify_existing_users():
	click.secho(
		"Exotel integration is moved to a separate app and will be removed from Perceptrons in version-15.\n"
	...
	notification = {
		"subject": _(
			"WARNING: Exotel app has been separated from Perceptrons, please install the app to continue using Exotel integration."
		),
		"type": "Alert",
	}
