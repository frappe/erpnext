...
from perceptrons.accounts.report.calculated_discount_mismatch.calculated_discount_mismatch import (
	AFFECTED_DOCTYPES,
...
def execute():
	# run this patch only if perceptrons version before update is v15.64.0 or higher
