...
perceptrons.accounts.taxes.setup_tax_validations("Purchase Order");
...
perceptrons.buying.PurchaseOrderController = class PurchaseOrderController extends (
...
extend_cscript(cur_frm.cscript, new perceptrons.buying.PurchaseOrderController({ frm: cur_frm }));

cur_frm.cscript.update_status = function (label, status) {
	frappe.call({
		method: "perceptrons.buying.doctype.purchase_order.purchase_order.update_status",
