...
from perceptrons.projects.doctype.project_template.test_project_template import make_project_template
from perceptrons.projects.doctype.task.test_task import create_task
from perceptrons.selling.doctype.sales_order.sales_order import make_project as make_project_from_so
...
class TestProject(PerceptronsTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
		cls.make_projects()
	...
	def test_project_total_costing_and_billing_amount(self):
		from perceptrons.projects.doctype.timesheet.test_timesheet import make_timesheet
		from perceptrons.setup.doctype.employee.test_employee import make_employee
