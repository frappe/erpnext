...
frappe.provide("perceptrons.projects");
...
frappe.ui.form.on("Task", {
		...
		frm.make_methods = {
			Timesheet: () =>
				frappe.model.open_mapped_doc({
					method: "perceptrons.projects.doctype.task.task.make_timesheet",
					frm: frm,
				}),
		};
	},
	...
	is_group: function (frm) {
		frappe.call({
			method: "perceptrons.projects.doctype.task.task.check_if_child_exists",
			args: {
				name: frm.doc.name,
			},
			callback: function (r) {
