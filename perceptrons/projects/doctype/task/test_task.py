...
from perceptrons.projects.doctype.task.task import CircularReferenceError, ParentIsGroupError
from perceptrons.tests.utils import PerceptronsTestSuite


class TestTask(PerceptronsTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
		cls.make_projects()
	...
	def test_overdue(self):
		...
		from perceptrons.projects.doctype.task.task import set_tasks_as_overdue
