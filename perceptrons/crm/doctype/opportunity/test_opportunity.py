...
from perceptrons.crm.doctype.lead.test_lead import make_lead
from perceptrons.crm.doctype.opportunity.opportunity import make_quotation
from perceptrons.crm.utils import get_linked_communication_list
from perceptrons.tests.utils import PerceptronsTestSuite


class TestOpportunity(PerceptronsTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
