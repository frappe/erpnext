...
from perceptrons.accounts.party import set_taxes
from perceptrons.controllers.selling_controller import SellingController
from perceptrons.crm.utils import CRMNote, copy_comments, link_communications, link_open_events
from perceptrons.selling.doctype.customer.customer import parse_full_name
...
def get_lead_details(lead, posting_date=None, company=None, doctype=None):
	...
	from perceptrons.accounts.party import set_address_details
