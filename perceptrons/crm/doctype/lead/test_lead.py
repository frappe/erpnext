...
from perceptrons.crm.doctype.lead.lead import make_opportunity
from perceptrons.crm.utils import get_linked_prospect
from perceptrons.tests.utils import PerceptronsTestSuite


class TestLead(PerceptronsTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
		cls.make_leads()
	...
	def test_make_customer(self):
		from perceptrons.crm.doctype.lead.lead import make_customer
