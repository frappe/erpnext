...
class Prospect(CRMNote):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.crm.doctype.prospect_lead.prospect_lead import ProspectLead
		from perceptrons.crm.doctype.prospect_opportunity.prospect_opportunity import ProspectOpportunity
