...
from perceptrons.stock.doctype.stock_closing_entry.stock_closing_entry import StockClosing
...
from perceptrons.stock.utils import add_additional_uom_columns
...
class StockBalanceReport:
	...
	def set_company_currency(self) -> None:
		if self.filters.get("company"):
			self.company_currency = perceptrons.get_company_currency(self.filters.get("company"))
		else:
