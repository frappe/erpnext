...
import perceptrons
from perceptrons.accounts.utils import get_currency_precision, get_stock_accounts
from perceptrons.stock.doctype.stock_reposting_settings.stock_reposting_settings import get_stock_ledgers
from perceptrons.stock.doctype.warehouse.warehouse import get_warehouses_based_on_account


def execute(filters=None):
	if not perceptrons.is_perpetual_inventory_enabled(filters.company):
		frappe.throw(
