...
import perceptrons
from perceptrons.stock.doctype.bin.bin import update_qty as update_bin_qty
...
from perceptrons.stock.valuation import FIFOValuation, LIFOValuation, round_off_if_near_zero
...
class update_entries_after:
	...
	def get_serialized_values(self, sle):
		from perceptrons.stock.serial_batch_bundle import SerialNoValuation
	...
	def update_serial_batch_no_valuation(self, sle, doc, prev_sle=None):
		from perceptrons.stock.serial_batch_bundle import BatchNoValuation, SerialNoValuation
	...
	def update_batched_values(self, sle):
		from perceptrons.stock.serial_batch_bundle import BatchNoValuation
	...
	def get_fallback_rate(self, sle) -> float:
		...
		return get_valuation_rate(
			...
			currency=perceptrons.get_company_currency(sle.company),
			company=sle.company,
		)
...
def get_valuation_rate(
	...
	if (
		...
		and cint(perceptrons.is_perpetual_inventory_enabled(company))
	):
