...
from perceptrons.selling.doctype.sales_order.sales_order import create_pick_list, make_delivery_note
...
from perceptrons.stock.doctype.stock_entry.stock_entry import StockEntry
...
class TestStockReservationEntry(IntegrationTestCase):
	...
	def test_stock_reservation_from_purchase_receipt(self) -> None:
		...
		from perceptrons.selling.doctype.sales_order.sales_order import make_material_request
		from perceptrons.stock.doctype.material_request.material_request import make_purchase_order
