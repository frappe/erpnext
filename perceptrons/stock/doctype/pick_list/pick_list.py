...
from perceptrons.stock.get_item_details import get_company_total_stock, get_conversion_factor
...
class PickList(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.stock.doctype.pick_list_item.pick_list_item import PickListItem
