...
import perceptrons
from perceptrons.accounts.general_ledger import validate_accounting_period
from perceptrons.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
from perceptrons.stock.stock_ledger import (
...
def repost_gl_entries(doc):
	if not cint(perceptrons.is_perpetual_inventory_enabled(doc.company)):
		return
...
def execute_repost_item_valuation():
	...
	method = "perceptrons.stock.doctype.repost_item_valuation.repost_item_valuation.repost_entries"
	if frappe.db.get_single_value("Stock Reposting Settings", "enable_parallel_reposting"):
		method = "perceptrons.stock.doctype.repost_item_valuation.repost_item_valuation.run_parallel_reposting"
