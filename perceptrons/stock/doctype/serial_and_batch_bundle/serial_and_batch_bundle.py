...
from perceptrons.stock.doctype.purchase_receipt_item.purchase_receipt_item import PurchaseReceiptItem
from perceptrons.stock.serial_batch_bundle import (
	BatchNoValuation,
	SerialNoValuation,
	get_batches_from_bundle,
)
from perceptrons.stock.serial_batch_bundle import get_serial_nos as get_serial_nos_from_bundle
from perceptrons.stock.valuation import FIFOValuation
...
class SerialandBatchBundle(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.stock.doctype.serial_and_batch_entry.serial_and_batch_entry import SerialandBatchEntry
	...
	def get_valuation_rate_for_return_entry(self, return_against):
		from perceptrons.controllers.sales_and_purchase_return import get_warehouses_for_return
...
def get_reserved_serial_nos_for_pos(kwargs):
	from perceptrons.controllers.sales_and_purchase_return import get_returned_serial_nos
