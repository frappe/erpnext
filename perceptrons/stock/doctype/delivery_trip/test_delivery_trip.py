...
import perceptrons
from perceptrons.stock.doctype.delivery_trip.delivery_trip import (
	get_contact_and_address,
	notify_customers,
)
from perceptrons.tests.utils import create_test_contact_and_address
	...
	delivery_trip = frappe.get_doc(
		{
			...
			"company": perceptrons.get_default_company(),
