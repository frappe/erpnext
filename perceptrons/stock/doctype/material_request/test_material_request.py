...
from perceptrons.stock.doctype.stock_entry.stock_entry import make_stock_in_entry
...
class TestMaterialRequest(IntegrationTestCase):
	...
	def test_make_subcontracted_purchase_order(self):
		...
		from perceptrons.subcontracting.doctype.subcontracting_bom.test_subcontracting_bom import (
	...
	def test_partial_make_stock_entry(self):
		from perceptrons.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry as _make_stock_entry
	...
	def test_auto_email_users_with_company_user_permissions(self):
		from perceptrons.stock.reorder_item import get_email_list
	...
	def test_pending_qty_in_pick_list(self):
		...
		from perceptrons.stock.doctype.pick_list.pick_list import create_stock_entry
