...
import perceptrons
import perceptrons.controllers
import perceptrons.controllers.status_updater
...
from perceptrons.controllers.buying_controller import QtyMismatchError
from perceptrons.stock import get_warehouse_account_map
from perceptrons.stock.doctype.item.test_item import create_item, make_item
from perceptrons.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_invoice
...
class TestPurchaseReceipt(IntegrationTestCase):
	...
	def test_purchase_receipt_gl_entry(self):
		...
		self.assertEqual(cint(perceptrons.is_perpetual_inventory_enabled(pr.company)), 1)
	...
	def test_pr_billing_status(self):
		...
		3. PO -> PR2.
		"""
		from perceptrons.buying.doctype.purchase_order.purchase_order import (
	...
	def test_purchase_return_with_submitted_asset(self):
		from perceptrons.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_return
	...
	def test_stock_transfer_from_purchase_receipt(self):
		from perceptrons.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
		from perceptrons.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
	...
	def test_stock_transfer_from_purchase_receipt_with_valuation(self):
		...
		from perceptrons.stock.get_item_details import get_valuation_rate
	...
	def test_po_to_pi_and_po_to_pr_worflow_full(self):
		...
		"""
		from perceptrons.buying.doctype.purchase_order import purchase_order, test_purchase_order
	...
	def test_purchase_receipt_with_exchange_rate_difference(self):
		from perceptrons.accounts.doctype.purchase_invoice.purchase_invoice import (
		...
		from perceptrons.accounts.party import add_party_account
	...
	def test_pr_billed_amount_against_return_entry(self):
		from perceptrons.accounts.doctype.purchase_invoice.purchase_invoice import make_debit_note
		from perceptrons.stock.doctype.purchase_receipt.purchase_receipt import (
	...
	def test_valuation_taxes_lcv_repost_after_billing(self):
		...
		old_perpetual_inventory = perceptrons.is_perpetual_inventory_enabled("_Test Company")
	...
	def test_sles_with_same_posting_datetime_and_creation(self):
		from perceptrons.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
		from perceptrons.stock.report.stock_balance.stock_balance import execute
	...
	def test_internal_pr_qty_change_only_single_batch(self):
		...
		self.assertRaises(perceptrons.controllers.status_updater.OverAllowanceError, pr.submit)
...
def prepare_data_for_internal_transfer():
	from perceptrons.accounts.doctype.sales_invoice.test_sales_invoice import create_internal_supplier
