...
from perceptrons.accounts.utils import update_gl_entries_after
...
class TestLandedCostVoucher(IntegrationTestCase):
	...
	def test_multi_currency_lcv(self):
		from perceptrons.setup.doctype.currency_exchange.test_currency_exchange import save_new_records
