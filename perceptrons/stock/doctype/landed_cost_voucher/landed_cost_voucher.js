...
perceptrons.landed_cost_taxes_and_charges.setup_triggers("Landed Cost Voucher");
perceptrons.stock.LandedCostVoucher = class LandedCostVoucher extends perceptrons.stock.StockController {
	refresh() {
...
cur_frm.script_manager.make(perceptrons.stock.LandedCostVoucher);
...
frappe.ui.form.on("Landed Cost Voucher", {
	...
	setup_queries(frm) {
		...
		frm.set_query("vendor_invoice", "vendor_invoices", (doc, cdt, cdn) => {
			return {
				query: "perceptrons.stock.doctype.landed_cost_voucher.landed_cost_voucher.get_vendor_invoices",
				filters: {
					company: doc.company,
				},
			};
