...
import perceptrons
from perceptrons.accounts.doctype.journal_entry.journal_entry import get_exchange_rate
from perceptrons.accounts.doctype.pricing_rule.utils import get_applied_pricing_rules
...
from perceptrons.stock.get_item_details import ItemDetailsCtx, _get_item_tax_template, get_item_tax_map
...
class calculate_taxes_and_totals:
	...
	def validate_conversion_rate(self):
		...
		company_currency = perceptrons.get_company_currency(self.doc.company)
