...
import perceptrons
from perceptrons.stock.get_item_details import ItemDetailsCtx, _get_item_tax_template
...
def tax_account_query(doctype: str, txt: str, searchfield: str, start: int, page_len: int, filters: dict):
	doctype = "Account"
	company_currency = perceptrons.get_company_currency(filters.get("company"))
