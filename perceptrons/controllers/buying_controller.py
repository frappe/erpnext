...
import perceptrons
from perceptrons.accounts.doctype.accounting_dimension.accounting_dimension import get_dimensions
from perceptrons.accounts.doctype.budget.budget import validate_expense_against_budget
from perceptrons.accounts.party import get_party_details
from perceptrons.buying.utils import update_last_purchase_rate, validate_for_items
from perceptrons.controllers.accounts_controller import get_taxes_and_charges
from perceptrons.controllers.sales_and_purchase_return import get_rate_for_return
from perceptrons.controllers.subcontracting_controller import SubcontractingController
from perceptrons.stock.get_item_details import get_conversion_factor, get_item_defaults
...
class BuyingController(SubcontractingController):
	...
	def validate_budget(self):
		if not frappe.get_single_value("Accounts Settings", "use_legacy_budget_controller"):
			from perceptrons.controllers.budget_controller import BudgetValidation
