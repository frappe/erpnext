...
import perceptrons
from perceptrons.stock.serial_batch_bundle import get_batches_from_bundle
from perceptrons.stock.utils import get_combine_datetime, get_incoming_rate, get_valuation_method, getdate
...
def validate_quantity(doc, key, args, ref, valid_items, already_returned_items):
	...
	company_currency = perceptrons.get_company_currency(doc.company)
