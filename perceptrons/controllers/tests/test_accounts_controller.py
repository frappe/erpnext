...
from perceptrons.accounts.doctype.purchase_invoice.test_purchase_invoice import make_purchase_invoice
...
from perceptrons.buying.doctype.purchase_order.test_purchase_order import (
...
class TestAccountsController(IntegrationTestCase):
	...
	def setup_dimensions(self):
		# create dimension
		from perceptrons.accounts.doctype.accounting_dimension.test_accounting_dimension import (
			create_dimension,
		)
	...
	def test_party_billing_and_shipping_address(self):
		from perceptrons.crm.doctype.prospect.test_prospect import make_address
	...
	def test_discount_amount_not_mapped_repeatedly_for_purchase_transactions(self):
		...
		"""
		from perceptrons.buying.doctype.purchase_order.purchase_order import make_purchase_receipt
		from perceptrons.buying.doctype.purchase_order.test_purchase_order import create_purchase_order
