...
from perceptrons.stock.serial_batch_bundle import SerialBatchCreation, get_serial_nos_from_bundle
...
class SubcontractingController(StockController):
	...
	def set_batch_for_supplied_items(self):
		from perceptrons.stock.get_item_details import get_filtered_serial_nos
