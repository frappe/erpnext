...
from perceptrons.accounts.party import render_address
from perceptrons.controllers.accounts_controller import get_taxes_and_charges
from perceptrons.controllers.sales_and_purchase_return import get_rate_for_return, is_batch_expired
from perceptrons.controllers.stock_controller import StockController
from perceptrons.stock.doctype.item.item import set_item_default
from perceptrons.stock.get_item_details import get_bin_details, get_conversion_factor
from perceptrons.stock.utils import get_combine_datetime, get_incoming_rate, get_valuation_method
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			...
			from perceptrons.crm.doctype.lead.lead import get_lead_details
	...
	def set_incoming_rate(self):
		...
		from perceptrons.stock.serial_batch_bundle import get_batch_nos, get_serial_nos
	...
	def validate_items(self):
		...
		from perceptrons.controllers.buying_controller import validate_item_type
