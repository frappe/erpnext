...
from perceptrons.assets.doctype.asset.asset import get_asset_account
...
class AssetRepair(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.assets.doctype.asset_repair_consumed_item.asset_repair_consumed_item import (
			AssetRepairConsumedItem,
		)
		from perceptrons.assets.doctype.asset_repair_purchase_invoice.asset_repair_purchase_invoice import (
