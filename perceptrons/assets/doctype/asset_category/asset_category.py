...
class AssetCategory(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.assets.doctype.asset_category_account.asset_category_account import AssetCategoryAccount
		from perceptrons.assets.doctype.asset_finance_book.asset_finance_book import AssetFinanceBook
