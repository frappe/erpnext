...
import perceptrons
from perceptrons.assets.doctype.asset.asset import get_asset_value_after_depreciation
from perceptrons.assets.doctype.asset.depreciation import (
	depreciate_asset,
...
from perceptrons.assets.doctype.asset_activity.asset_activity import add_asset_activity
from perceptrons.assets.doctype.asset_category.asset_category import get_asset_category_account
from perceptrons.controllers.stock_controller import StockController
...
from perceptrons.stock.utils import get_incoming_rate
...
class AssetCapitalization(StockController):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.assets.doctype.asset_capitalization_asset_item.asset_capitalization_asset_item import (
			AssetCapitalizationAssetItem,
		)
		from perceptrons.assets.doctype.asset_capitalization_service_item.asset_capitalization_service_item import (
			AssetCapitalizationServiceItem,
		)
		from perceptrons.assets.doctype.asset_capitalization_stock_item.asset_capitalization_stock_item import (
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False):
		from perceptrons.accounts.general_ledger import make_gl_entries, make_reverse_gl_entries
