frappe.provide("perceptrons.timesheet");

perceptrons.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	perceptrons.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

perceptrons.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {
