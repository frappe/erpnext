...
from perceptrons.controllers.stock_controller import (
	QualityInspectionNotSubmittedError,
	QualityInspectionRejectedError,
)
from perceptrons.manufacturing.doctype.bom.bom import add_additional_cost, get_bom_items_as_dict
from perceptrons.manufacturing.doctype.manufacturing_settings.manufacturing_settings import (
	get_mins_between_operations,
)
from perceptrons.manufacturing.doctype.workstation_type.workstation_type import get_workstations
...
class JobCard(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.manufacturing.doctype.job_card_item.job_card_item import JobCardItem
		from perceptrons.manufacturing.doctype.job_card_operation.job_card_operation import JobCardOperation
		from perceptrons.manufacturing.doctype.job_card_scheduled_time.job_card_scheduled_time import (
			JobCardScheduledTime,
		)
		from perceptrons.manufacturing.doctype.job_card_scrap_item.job_card_scrap_item import JobCardScrapItem
		from perceptrons.manufacturing.doctype.job_card_time_log.job_card_time_log import JobCardTimeLog
	...
	def make_stock_entry_for_semi_fg_item(self, auto_submit: bool = False):
		from perceptrons.stock.doctype.stock_entry_type.stock_entry_type import ManufactureEntry
