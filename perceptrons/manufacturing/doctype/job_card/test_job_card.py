...
from perceptrons.manufacturing.doctype.job_card.job_card import (
...
from perceptrons.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
from perceptrons.manufacturing.doctype.work_order.work_order import WorkOrder, make_work_order
from perceptrons.manufacturing.doctype.workstation.test_workstation import make_workstation
...
class TestJobCard(PerceptronsTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
	...
	def test_quality_inspection_mandatory_check(self):
		from perceptrons.manufacturing.doctype.operation.test_operation import make_operation
	...
	def test_if_corrective_jc_ops_cost_is_added_to_manufacture_stock_entry(self):
		...
		from perceptrons.manufacturing.doctype.work_order.work_order import make_job_card
	...
	def test_job_card_material_request_and_bom_details(self):
		from perceptrons.stock.doctype.material_request.material_request import make_stock_entry
	...
	def test_job_card_proccess_qty_and_completed_qty(self):
		from perceptrons.manufacturing.doctype.routing.test_routing import (
			create_routing,
			setup_bom,
			setup_operations,
		)
