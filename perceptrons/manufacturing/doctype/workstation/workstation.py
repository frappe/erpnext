...
from perceptrons.support.doctype.issue.issue import get_holidays
...
class Workstation(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.manufacturing.doctype.workstation_working_hour.workstation_working_hour import (
