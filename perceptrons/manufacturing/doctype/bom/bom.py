...
from perceptrons.stock.doctype.item.item import get_item_details
from perceptrons.stock.get_item_details import ItemDetailsCtx, get_conversion_factor, get_price_list_rate
...
class BOM(WebsiteGenerator):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.manufacturing.doctype.bom_explosion_item.bom_explosion_item import BOMExplosionItem
		from perceptrons.manufacturing.doctype.bom_item.bom_item import BOMItem
		from perceptrons.manufacturing.doctype.bom_operation.bom_operation import BOMOperation
		from perceptrons.manufacturing.doctype.bom_scrap_item.bom_scrap_item import BOMScrapItem
	...
	def company_currency(self):
		return perceptrons.get_company_currency(self.company)
...
def add_operations_cost(stock_entry, work_order=None, expense_account=None, job_card=None):
	from perceptrons.stock.doctype.stock_entry.stock_entry import (
...
def make_variant_bom(
	...
	from perceptrons.manufacturing.doctype.work_order.work_order import add_variant_item
