...
from perceptrons.manufacturing.doctype.bom_update_log.bom_update_log import (
	BOMMissingError,
	resume_bom_cost_update_jobs,
)
from perceptrons.manufacturing.doctype.bom_update_tool.bom_update_tool import (
	enqueue_replace_bom,
	enqueue_update_cost,
)
...
class TestBOMUpdateLog(IntegrationTestCase):
	...
	def test_bom_replace_for_root_bom(self):
		...
		from perceptrons.manufacturing.doctype.bom.test_bom import create_nested_bom
