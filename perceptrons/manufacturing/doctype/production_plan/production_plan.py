...
from perceptrons.manufacturing.doctype.bom.bom import get_children as get_bom_children
from perceptrons.manufacturing.doctype.bom.bom import validate_bom_no
from perceptrons.manufacturing.doctype.work_order.work_order import get_item_details
from perceptrons.setup.doctype.item_group.item_group import get_item_group_defaults
from perceptrons.stock.doctype.stock_reservation_entry.stock_reservation_entry import StockReservation
from perceptrons.stock.get_item_details import get_conversion_factor
from perceptrons.stock.utils import get_or_make_bin
from perceptrons.utilities.transaction_base import validate_uom_is_integer
...
class ProductionPlan(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.manufacturing.doctype.material_request_plan_item.material_request_plan_item import (
			MaterialRequestPlanItem,
		)
		from perceptrons.manufacturing.doctype.production_plan_item.production_plan_item import ProductionPlanItem
		from perceptrons.manufacturing.doctype.production_plan_item_reference.production_plan_item_reference import (
			ProductionPlanItemReference,
		)
		from perceptrons.manufacturing.doctype.production_plan_material_request.production_plan_material_request import (
			ProductionPlanMaterialRequest,
		)
		from perceptrons.manufacturing.doctype.production_plan_material_request_warehouse.production_plan_material_request_warehouse import (
			ProductionPlanMaterialRequestWarehouse,
		)
		from perceptrons.manufacturing.doctype.production_plan_sales_order.production_plan_sales_order import (
			ProductionPlanSalesOrder,
		)
		from perceptrons.manufacturing.doctype.production_plan_sub_assembly_item.production_plan_sub_assembly_item import (
	...
	def make_work_order(self):
		from perceptrons.manufacturing.doctype.work_order.work_order import get_default_warehouse
	...
	def create_work_order(self, item):
		from perceptrons.manufacturing.doctype.work_order.work_order import OverProductionError
...
def get_materials_from_other_locations(item, warehouses, new_mr_items, company):
	from perceptrons.stock.doctype.pick_list.pick_list import get_available_item_locations
...
def get_reserved_qty_for_production_plan(item_code, warehouse):
	from perceptrons.manufacturing.doctype.work_order.work_order import get_reserved_qty_for_production
