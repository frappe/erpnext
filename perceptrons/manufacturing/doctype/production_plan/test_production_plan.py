...
from perceptrons.manufacturing.doctype.work_order.work_order import make_stock_entry as make_se_from_wo
...
class TestProductionPlan(IntegrationTestCase):
	...
	def test_get_sales_order_items_for_product_bundle(self):
		...
		from perceptrons.manufacturing.doctype.work_order.test_work_order import (
