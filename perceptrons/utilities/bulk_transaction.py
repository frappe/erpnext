...
def task(doc_name, from_doctype, to_doctype):
	from perceptrons.accounts.doctype.payment_entry import payment_entry
	from perceptrons.accounts.doctype.purchase_invoice import purchase_invoice
	from perceptrons.accounts.doctype.sales_invoice import sales_invoice
	from perceptrons.buying.doctype.purchase_order import purchase_order
	from perceptrons.buying.doctype.supplier_quotation import supplier_quotation
	from perceptrons.selling.doctype.quotation import quotation
	from perceptrons.selling.doctype.sales_order import sales_order
	from perceptrons.stock.doctype.delivery_note import delivery_note
	from perceptrons.stock.doctype.purchase_receipt import purchase_receipt
