...
from perceptrons.stock.utils import get_valid_serial_nos
...
class InstallationNote(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.selling.doctype.installation_note_item.installation_note_item import (
	...
	def validate(self):
		...
		from perceptrons.controllers.selling_controller import set_default_income_account_for_item
