...
from perceptrons.exceptions import PartyDisabled, PartyFrozen
from perceptrons.selling.doctype.customer.customer import (
	get_credit_limit,
...
class TestCustomer(IntegrationTestCase):
	...
	def test_customer_credit_limit_after_submit(self):
		from perceptrons.controllers.accounts_controller import update_child_qty_rate
		from perceptrons.selling.doctype.sales_order.test_sales_order import make_sales_order
