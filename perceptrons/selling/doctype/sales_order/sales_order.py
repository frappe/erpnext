...
from perceptrons.accounts.party import get_party_account
from perceptrons.controllers.selling_controller import SellingController
from perceptrons.manufacturing.doctype.blanket_order.blanket_order import (
	validate_against_blanket_order,
)
from perceptrons.manufacturing.doctype.production_plan.production_plan import (
	get_items_for_material_requests,
)
from perceptrons.selling.doctype.customer.customer import check_credit_limit
from perceptrons.setup.doctype.item_group.item_group import get_item_group_defaults
from perceptrons.stock.doctype.item.item import get_item_defaults
...
from perceptrons.stock.stock_balance import get_reserved_qty, update_bin_qty
...
class SalesOrder(SellingController):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.sales_taxes_and_charges.sales_taxes_and_charges import (
			SalesTaxesandCharges,
		)
		from perceptrons.selling.doctype.sales_order_item.sales_order_item import SalesOrderItem
		from perceptrons.selling.doctype.sales_team.sales_team import SalesTeam
		from perceptrons.stock.doctype.packed_item.packed_item import PackedItem
	...
	def validate(self):
		...
		if self.coupon_code:
			from perceptrons.accounts.doctype.pricing_rule.utils import validate_coupon_code
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from perceptrons.accounts.doctype.pricing_rule.utils import update_coupon_code_count
	...
	def update_subcontracting_order_status(self):
		from perceptrons.subcontracting.doctype.subcontracting_inward_order.subcontracting_inward_order import (
...
def create_pick_list(source_name: str, target_doc: str | Document | None = None):
	from perceptrons.stock.doctype.packed_item.packed_item import is_product_bundle
