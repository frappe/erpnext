...
perceptrons.accounts.taxes.setup_tax_validations("Sales Taxes and Charges Template");
perceptrons.accounts.taxes.setup_tax_filters("Sales Taxes and Charges");
perceptrons.pre_sales.set_as_lost("Quotation");
...
perceptrons.selling.QuotationController = class QuotationController extends perceptrons.selling.SellingController {
	onload(doc, dt, dn) {
	...
	get_lead_details() {
		...
		frappe.call({
			method: "perceptrons.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(perceptrons.selling.QuotationController);
