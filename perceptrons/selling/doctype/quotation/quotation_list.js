	...
	onload: function (listview) {
		...
		if (frappe.model.can_create("Sales Order")) {
			listview.page.add_action_item(__("Sales Order"), () => {
				perceptrons.bulk_transaction_processing.create(listview, "Quotation", "Sales Order");
			});
		}

		if (frappe.model.can_create("Sales Invoice")) {
			listview.page.add_action_item(__("Sales Invoice"), () => {
				perceptrons.bulk_transaction_processing.create(listview, "Quotation", "Sales Invoice");
			});
		}
	},
