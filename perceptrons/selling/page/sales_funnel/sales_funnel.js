...
frappe.pages["sales-funnel"].on_page_load = function (wrapper) {
	...
	wrapper.sales_funnel = new perceptrons.SalesFunnel(wrapper);

	frappe.breadcrumbs.add("Selling");
};

perceptrons.SalesFunnel = class SalesFunnel {
	constructor(wrapper) {
		var me = this;
	...
	get_data(btn) {
		...
		const method_map = {
			sales_funnel: "perceptrons.selling.page.sales_funnel.sales_funnel.get_funnel_data",
			opp_by_utm_source: "perceptrons.selling.page.sales_funnel.sales_funnel.get_opp_by_utm_source",
			opp_by_utm_campaign: "perceptrons.selling.page.sales_funnel.sales_funnel.get_opp_by_utm_campaign",
			opp_by_utm_medium: "perceptrons.selling.page.sales_funnel.sales_funnel.get_opp_by_utm_medium",
			sales_pipeline: "perceptrons.selling.page.sales_funnel.sales_funnel.get_pipeline_data",
		};
		frappe.call({
