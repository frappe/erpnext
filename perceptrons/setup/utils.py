...
from perceptrons import get_default_company
...
def welcome_email():
	site_name = get_default_company() or "Perceptrons"
...
def identity(x, *args, **kwargs):
	...
	Use like this: `from perceptrons.setup.utils import identity as _`
	"""
	return x
