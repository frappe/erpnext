...
class TransactionDeletionRecord(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.transaction_deletion_record_details.transaction_deletion_record_details import (
			TransactionDeletionRecordDetails,
		)
		from perceptrons.setup.doctype.transaction_deletion_record_item.transaction_deletion_record_item import (
			TransactionDeletionRecordItem,
		)
		from perceptrons.setup.doctype.transaction_deletion_record_to_delete.transaction_deletion_record_to_delete import (
