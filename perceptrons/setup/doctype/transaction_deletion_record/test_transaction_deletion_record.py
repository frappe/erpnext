...
class TestTransactionDeletionRecord(IntegrationTestCase):
	...
	def test_company_transaction_deletion_request(self):
		...
		from perceptrons.setup.doctype.company.company import create_transaction_deletion_request
	...
	def test_get_naming_series_prefix_with_dot(self):
		...
		from perceptrons.setup.doctype.transaction_deletion_record.transaction_deletion_record import (
