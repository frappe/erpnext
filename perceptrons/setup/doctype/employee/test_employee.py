...
import perceptrons
from perceptrons.accounts.utils import build_qb_match_conditions
from perceptrons.setup.doctype.employee.employee import InactiveEmployeeStatusError
		...
		employee = frappe.get_doc(
			{
				...
				"naming_series": "EMP-",
				"first_name": user,
				"company": company or perceptrons.get_default_company(),
				"user_id": user,
