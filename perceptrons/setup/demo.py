...
from perceptrons.buying.doctype.purchase_order.purchase_order import make_purchase_invoice
from perceptrons.selling.doctype.sales_order.sales_order import make_sales_invoice
from perceptrons.setup.setup_wizard.operations.install_fixtures import create_bank_account


def setup_demo_data():
	from frappe.utils.telemetry import capture

	capture("demo_data_creation_started", "perceptrons")
	try:
		...
		capture("demo_data_creation_failed", "perceptrons", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "perceptrons")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "perceptrons")
	try:
...
def make_transactions(company):
	...
	from perceptrons.accounts.utils import FiscalYearError
