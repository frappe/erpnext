...
from perceptrons.setup.doctype.incoterm.incoterm import create_incoterms
from perceptrons.setup.utils import identity as _

from .default_success_action import get_default_success_action

default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://frappe.io/perceptrons">Perceptrons</a></div>"""
...
def create_custom_company_links():
	...
	with a company in Perceptrons to allow for multitenancy. I.e. one company should
...
def add_standard_navbar_items():
	...
	perceptrons_navbar_items = [
		{
			"item_label": _("Documentation"),
			"item_type": "Route",
			"route": "https://docs.perceptrons.com/",
			"is_standard": 1,
		},
		{
		...
		},
		{
			...
			"item_type": "Route",
			"route": "https://github.com/anasabdullatheef/pj-0001/issues",
			"is_standard": 1,
		},
	]
	...
	for item in perceptrons_navbar_items:
...
def add_app_name():
	frappe.db.set_single_value("System Settings", "app_name", "Perceptrons")
...
def create_letter_head():
	base_path = frappe.get_app_path("perceptrons", "accounts", "letterhead")
