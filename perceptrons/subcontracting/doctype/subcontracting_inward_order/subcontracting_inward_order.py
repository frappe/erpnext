# Copyright (c) 2025, Hash Include Solutions FZC and contributors
...
class SubcontractingInwardOrder(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.subcontracting.doctype.subcontracting_inward_order_item.subcontracting_inward_order_item import (
			SubcontractingInwardOrderItem,
		)
		from perceptrons.subcontracting.doctype.subcontracting_inward_order_received_item.subcontracting_inward_order_received_item import (
			SubcontractingInwardOrderReceivedItem,
		)
		from perceptrons.subcontracting.doctype.subcontracting_inward_order_scrap_item.subcontracting_inward_order_scrap_item import (
			SubcontractingInwardOrderScrapItem,
		)
		from perceptrons.subcontracting.doctype.subcontracting_inward_order_service_item.subcontracting_inward_order_service_item import (
