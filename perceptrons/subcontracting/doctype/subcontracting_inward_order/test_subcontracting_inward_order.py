...
from perceptrons.manufacturing.doctype.work_order.work_order import make_stock_entry as make_stock_entry_from_wo
from perceptrons.selling.doctype.sales_order.sales_order import make_subcontracting_inward_order
...
def make_service_items():
	from perceptrons.controllers.tests.test_subcontracting_controller import make_service_item
