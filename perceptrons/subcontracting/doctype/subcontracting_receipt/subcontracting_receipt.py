...
from perceptrons.stock.get_item_details import get_default_cost_center, get_default_expense_account
from perceptrons.stock.stock_ledger import get_valuation_rate
...
class SubcontractingReceipt(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.subcontracting.doctype.subcontracting_receipt_item.subcontracting_receipt_item import (
			SubcontractingReceiptItem,
		)
		from perceptrons.subcontracting.doctype.subcontracting_receipt_supplied_item.subcontracting_receipt_supplied_item import (
	...
	def get_gl_entries(self, inventory_account_map=None):
		...
		if not perceptrons.is_perpetual_inventory_enabled(self.company):
			return []
