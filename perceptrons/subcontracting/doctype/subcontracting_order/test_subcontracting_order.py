...
from perceptrons.buying.doctype.purchase_order.purchase_order import get_mapped_subcontracting_order
...
class TestSubcontractingOrder(IntegrationTestCase):
	...
	def test_stock_reservation_transfer(self):
		...
		from perceptrons.manufacturing.doctype.production_plan.test_production_plan import create_production_plan
		from perceptrons.stock.doctype.stock_reservation_entry.stock_reservation_entry import (
