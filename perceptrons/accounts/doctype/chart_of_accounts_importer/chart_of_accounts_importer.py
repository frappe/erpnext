...
from perceptrons.accounts.doctype.account.chart_of_accounts.chart_of_accounts import (
...
def set_default_accounts(company):
	from perceptrons.setup.doctype.company.company import install_country_fixtures
