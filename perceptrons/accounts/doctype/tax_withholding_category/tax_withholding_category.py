...
from perceptrons import allow_regional
...
class TaxWithholdingCategory(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.tax_withholding_account.tax_withholding_account import (
			TaxWithholdingAccount,
		)
		from perceptrons.accounts.doctype.tax_withholding_rate.tax_withholding_rate import TaxWithholdingRate
