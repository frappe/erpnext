...
frappe.provide("perceptrons.cheque_print");
	...
	refresh: function (frm) {
		if (!frm.doc.__islocal) {
			frm.add_custom_button(
				...
				function () {
					perceptrons.cheque_print.view_cheque_print(frm);
				}
...
perceptrons.cheque_print.view_cheque_print = function (frm) {
	frappe.call({
		method: "perceptrons.accounts.doctype.cheque_print_template.cheque_print_template.create_or_update_cheque_print_format",
		args: {
