...
from perceptrons.accounts.doctype.payment_entry.payment_entry import (
	get_payment_entry,
)
from perceptrons.accounts.doctype.subscription_plan.subscription_plan import get_plan_rate
from perceptrons.accounts.party import get_party_account, get_party_bank_account
from perceptrons.accounts.utils import get_account_currency, get_advance_payment_doctypes, get_currency_precision
from perceptrons.utilities import payment_app_import_guard
...
class PaymentRequest(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.payment_reference.payment_reference import PaymentReference
		from perceptrons.accounts.doctype.subscription_plan_detail.subscription_plan_detail import (
