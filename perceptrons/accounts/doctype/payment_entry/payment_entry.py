...
from perceptrons.accounts.doctype.bank_account.bank_account import (
...
from perceptrons.accounts.doctype.journal_entry.journal_entry import get_default_bank_cash_account
from perceptrons.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger import (
	validate_docs_for_deferred_accounting,
	validate_docs_for_voucher_types,
)
from perceptrons.accounts.doctype.tax_withholding_entry.tax_withholding_entry import PaymentTaxWithholding
...
class PaymentEntry(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.advance_taxes_and_charges.advance_taxes_and_charges import (
			AdvanceTaxesandCharges,
		)
		from perceptrons.accounts.doctype.payment_entry_deduction.payment_entry_deduction import (
			PaymentEntryDeduction,
		)
		from perceptrons.accounts.doctype.payment_entry_reference.payment_entry_reference import (
...
def get_reference_details(
	...
	company_currency = ref_doc.get("company_currency") or perceptrons.get_company_currency(ref_doc.company)
