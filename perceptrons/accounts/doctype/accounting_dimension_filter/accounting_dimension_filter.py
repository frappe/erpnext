...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from perceptrons.accounts.doctype.applicable_on_account.applicable_on_account import ApplicableOnAccount
