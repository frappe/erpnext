...
import perceptrons
from perceptrons.accounts.deferred_revenue import validate_service_stop_date
from perceptrons.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger import (
	validate_docs_for_deferred_accounting,
	validate_docs_for_voucher_types,
)
from perceptrons.accounts.doctype.sales_invoice.sales_invoice import (
...
from perceptrons.accounts.doctype.tax_withholding_entry.tax_withholding_entry import PurchaseTaxWithholding
from perceptrons.accounts.general_ledger import (
	get_round_off_account_and_cost_center,
	make_gl_entries,
	make_reverse_gl_entries,
	merge_similar_entries,
)
from perceptrons.accounts.party import get_due_date, get_party_account
from perceptrons.accounts.utils import get_account_currency, get_fiscal_year, update_voucher_outstanding
from perceptrons.assets.doctype.asset.asset import is_cwip_accounting_enabled
from perceptrons.assets.doctype.asset_category.asset_category import get_asset_category_account
from perceptrons.buying.utils import check_on_hold_or_closed_status
from perceptrons.controllers.accounts_controller import merge_taxes, validate_account_head
from perceptrons.controllers.buying_controller import BuyingController
from perceptrons.stock.doctype.purchase_receipt.purchase_receipt import (
...
class PurchaseInvoice(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.item_wise_tax_detail.item_wise_tax_detail import ItemWiseTaxDetail
		from perceptrons.accounts.doctype.payment_schedule.payment_schedule import PaymentSchedule
		from perceptrons.accounts.doctype.pricing_rule_detail.pricing_rule_detail import PricingRuleDetail
		from perceptrons.accounts.doctype.purchase_invoice_advance.purchase_invoice_advance import (
			PurchaseInvoiceAdvance,
		)
		from perceptrons.accounts.doctype.purchase_invoice_item.purchase_invoice_item import PurchaseInvoiceItem
		from perceptrons.accounts.doctype.purchase_taxes_and_charges.purchase_taxes_and_charges import (
			PurchaseTaxesandCharges,
		)
		from perceptrons.accounts.doctype.tax_withholding_entry.tax_withholding_entry import TaxWithholdingEntry
		from perceptrons.buying.doctype.purchase_receipt_item_supplied.purchase_receipt_item_supplied import (
	...
	def set_expense_account(self, for_validate=False):
		auto_accounting_for_stock = perceptrons.is_perpetual_inventory_enabled(self.company)
	...
	def get_gl_entries(self, inventory_account_map=None):
		self.auto_accounting_for_stock = perceptrons.is_perpetual_inventory_enabled(self.company)
	...
	def update_billing_status_in_pr(self, update_modified=True):
		...
		for pr in set(updated_pr):
			from perceptrons.stock.doctype.purchase_receipt.purchase_receipt import update_billing_percentage
...
def get_list_context(context=None):
	from perceptrons.controllers.website_list_for_contact import get_list_context
...
def make_purchase_receipt(
	...
	def update_item(obj, target, source_parent):
		from perceptrons.controllers.sales_and_purchase_return import get_returned_qty_map_for_row
