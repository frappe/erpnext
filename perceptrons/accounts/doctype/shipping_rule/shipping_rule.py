...
class ShippingRule(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.shipping_rule_condition.shipping_rule_condition import (
			ShippingRuleCondition,
		)
		from perceptrons.accounts.doctype.shipping_rule_country.shipping_rule_country import (
			ShippingRuleCountry,
		)
