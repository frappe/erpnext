...
from perceptrons.accounts.doctype.account_category.account_category import import_account_categories
from perceptrons.accounts.doctype.financial_report_template.financial_report_validation import TemplateValidator
...
class FinancialReportTemplate(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.financial_report_row.financial_report_row import FinancialReportRow
	...
	def _export_account_categories(self):
		...
		from perceptrons.accounts.doctype.financial_report_template.financial_report_engine import (
...
def sync_financial_report_templates(chart_of_accounts=None, existing_company=None):
	from perceptrons.accounts.doctype.account.chart_of_accounts.chart_of_accounts import get_chart
	...
	# Allow regional templates to completely override Perceptrons
	...
	for app in installed_apps:
		if disable_default_financial_report_template and app == "perceptrons":
			continue
