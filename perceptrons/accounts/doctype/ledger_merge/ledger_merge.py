...
from perceptrons.accounts.doctype.account.account import merge_account
...
class LedgerMerge(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.ledger_merge_accounts.ledger_merge_accounts import (
			LedgerMergeAccounts,
		)
