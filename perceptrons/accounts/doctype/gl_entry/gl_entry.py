...
from perceptrons.accounts.utils import OUTSTANDING_DOCTYPES, get_account_currency, get_fiscal_year
from perceptrons.exceptions import InvalidAccountCurrency, ReportingCurrencyExchangeNotFoundError
...
def update_against_account(voucher_type, voucher_no):
	...
	if not entries:
		return
	company_currency = perceptrons.get_company_currency(entries[0].company)
