...
from perceptrons.stock.get_item_details import get_item_details
...
class TestPricingRule(IntegrationTestCase):
	...
	def test_pricing_rule_for_discount(self):
		...
		from perceptrons.accounts.doctype.pricing_rule.utils import MultiplePricingRuleConflict
