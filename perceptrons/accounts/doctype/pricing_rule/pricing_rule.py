...
class PricingRule(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.pricing_rule_brand.pricing_rule_brand import PricingRuleBrand
		from perceptrons.accounts.doctype.pricing_rule_item_code.pricing_rule_item_code import PricingRuleItemCode
		from perceptrons.accounts.doctype.pricing_rule_item_group.pricing_rule_item_group import (
...
def apply_price_discount_rule(pricing_rule, item_details, args):
	...
	if pricing_rule.rate_or_discount == "Rate":
		...
		# TODO https://github.com/anasabdullatheef/pj-0001/pull/23636 solve this in some other way.
