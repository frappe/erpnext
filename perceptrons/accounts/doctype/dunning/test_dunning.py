...
from perceptrons.accounts.doctype.sales_invoice.test_sales_invoice import (
...
def create_payment_terms_template_for_dunning():
	from perceptrons.accounts.doctype.payment_entry.test_payment_entry import create_payment_term
