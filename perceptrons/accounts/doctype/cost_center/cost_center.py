...
from perceptrons.accounts.utils import validate_field_number
...
class CostCenter(NestedSet):
	...
	def autoname(self):
		from perceptrons.accounts.utils import get_autoname_with_number
	...
	def before_rename(self, olddn, newdn, merge=False):
		...
		from perceptrons.setup.doctype.company.company import get_name_with_abbr
