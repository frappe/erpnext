...
from perceptrons.accounts.doctype.sales_invoice.sales_invoice import PartialPaymentValidationError
...
class TestPOSInvoice(IntegrationTestCase):
	...
	def test_loyalty_points(self):
		...
		from perceptrons.accounts.doctype.loyalty_program.test_loyalty_program import create_records
	...
	def test_ignore_pricing_rule(self):
		from perceptrons.accounts.doctype.pricing_rule.test_pricing_rule import make_pricing_rule
	...
	def test_delivered_serial_no_case(self):
		from perceptrons.accounts.doctype.pos_invoice_merge_log.test_pos_invoice_merge_log import (
			init_user_and_profile,
		)
	...
	def test_bundle_stock_availability_validation(self):
		from perceptrons.accounts.doctype.pos_invoice.pos_invoice import ProductBundleStockValidationError
		from perceptrons.accounts.doctype.pos_invoice_merge_log.test_pos_invoice_merge_log import (
			init_user_and_profile,
		)
