...
from perceptrons.accounts.doctype.loyalty_program.loyalty_program import validate_loyalty_points
from perceptrons.accounts.doctype.payment_request.payment_request import make_payment_request
...
from perceptrons.controllers.queries import item_query as _item_query
from perceptrons.controllers.sales_and_purchase_return import get_sales_invoice_item_from_consolidated_invoice
from perceptrons.stock.doctype.serial_no.serial_no import get_serial_nos
from perceptrons.stock.stock_ledger import is_negative_stock_allowed
...
class POSInvoice(SalesInvoice):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.pos_invoice_item.pos_invoice_item import POSInvoiceItem
		from perceptrons.accounts.doctype.pricing_rule_detail.pricing_rule_detail import PricingRuleDetail
		from perceptrons.accounts.doctype.sales_invoice_advance.sales_invoice_advance import SalesInvoiceAdvance
		from perceptrons.accounts.doctype.sales_invoice_payment.sales_invoice_payment import SalesInvoicePayment
		from perceptrons.accounts.doctype.sales_invoice_timesheet.sales_invoice_timesheet import (
...
def create_payments_on_invoice(doc, idx, payment_details):
	from perceptrons.accounts.doctype.sales_invoice.sales_invoice import get_bank_cash_account
