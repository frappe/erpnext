			...
			frm.add_custom_button(
				...
				function () {
					frappe.route_options = {
						...
						from_date: perceptrons.utils.get_fiscal_year(frappe.datetime.get_today(), true)[1],
						to_date: perceptrons.utils.get_fiscal_year(frappe.datetime.get_today(), true)[2],
	...
	merge_account: function (frm) {
		var d = new frappe.ui.Dialog({
			...
			primary_action: function () {
				...
				frappe.call({
					method: "perceptrons.accounts.doctype.account.account.merge_account",
					args: {
						old: frm.doc.name,
						new: data.name,
					},
	...
	update_account_number: function (frm) {
		var d = new frappe.ui.Dialog({
			...
			primary_action: function () {
				...
				frappe.call({
					method: "perceptrons.accounts.doctype.account.account.update_account_number",
					args: {
