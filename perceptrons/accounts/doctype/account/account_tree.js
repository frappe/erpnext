...
frappe.treeview_settings["Account"] = {
	...
	filters: [
		{
			...
			on_change: function () {
				...
				frappe.call({
					method: "perceptrons.accounts.doctype.account.account.get_root_company",
					args: {
						company: company,
					},
					callback: function (r) {
		...
		frappe.db.get_single_value("Accounts Settings", "show_balance_in_coa").then((value) => {
			if (value) {
				const get_balances = frappe.call({
					method: "perceptrons.accounts.utils.get_account_balances",
					args: {
						accounts: accounts,
	...
	add_tree_node: "perceptrons.accounts.utils.add_ac",
	menu_items: [
		{
