...
from perceptrons.accounts.doctype.tax_withholding_entry.tax_withholding_entry import SalesTaxWithholding
from perceptrons.accounts.general_ledger import get_round_off_account_and_cost_center
from perceptrons.accounts.party import get_due_date, get_party_account, get_party_details
from perceptrons.accounts.utils import (
	get_account_currency,
	update_voucher_outstanding,
)
from perceptrons.assets.doctype.asset.asset import split_asset
...
from perceptrons.projects.doctype.timesheet.timesheet import get_projectwise_timesheet_data
from perceptrons.setup.doctype.company.company import update_company_current_month_sales
from perceptrons.stock.doctype.delivery_note.delivery_note import update_billed_amount_based_on_so
...
class SalesInvoice(SellingController):
	...
	def get_gl_entries(self, inventory_account_map=None):
		from perceptrons.accounts.general_ledger import merge_similar_entries
	...
	def make_item_gl_entries(self, gl_entries):
		...
		if cint(self.update_stock) and perceptrons.is_perpetual_inventory_enabled(self.company):
	...
	def apply_loyalty_points(self):
		from perceptrons.accounts.doctype.loyalty_point_entry.loyalty_point_entry import (
...
def get_loyalty_programs(customer: str):
	...
	from perceptrons.selling.doctype.customer.customer import get_loyalty_programs
...
def create_dunning(
	...
	def postprocess_dunning(source, target):
		from perceptrons.accounts.doctype.dunning.dunning import get_dunning_letter_text
