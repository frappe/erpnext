...
from perceptrons.accounts.doctype.pos_profile.pos_profile import (
	get_child_nodes,
)
from perceptrons.stock.get_item_details import get_pos_profile
...
class TestPOSProfile(IntegrationTestCase):
	...
	def test_disabled_pos_profile_after_completing_session(self):
		...
		from perceptrons.accounts.doctype.pos_closing_entry.test_pos_closing_entry import init_user_and_profile
		from perceptrons.accounts.doctype.pos_opening_entry.test_pos_opening_entry import (
