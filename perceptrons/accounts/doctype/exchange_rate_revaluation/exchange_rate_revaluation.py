...
import perceptrons
from perceptrons.accounts.doctype.journal_entry.journal_entry import get_balance_on
from perceptrons.accounts.utils import get_currency_precision
...
class ExchangeRateRevaluation(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.exchange_rate_revaluation_account.exchange_rate_revaluation_account import (
...
def get_account_details(
	...
	account_details = {}
	perceptrons.get_company_currency(company)
