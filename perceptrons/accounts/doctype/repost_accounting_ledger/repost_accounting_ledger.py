...
class RepostAccountingLedger(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.repost_accounting_ledger_items.repost_accounting_ledger_items import (
	...
	def generate_preview(self):
		...
		rendered_page = frappe.render_template(
			"perceptrons/accounts/doctype/repost_accounting_ledger/repost_accounting_ledger.html",
	...
	def on_submit(self):
		if len(self.vouchers) > 5:
			...
			frappe.enqueue(
				method="perceptrons.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger.start_repost",
