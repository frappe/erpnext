...
from perceptrons.accounts.doctype.bank_transaction.bank_transaction import get_total_allocated_amount
from perceptrons.accounts.party import get_party_account
from perceptrons.accounts.report.bank_reconciliation_statement.bank_reconciliation_statement import (
	get_amounts_not_reflected_in_system,
	get_entries,
)
from perceptrons.accounts.utils import get_account_currency, get_balance_on
...
def auto_reconcile_vouchers(
	...
	if len(bank_transactions) > 10:
		for bank_transaction_batch in create_batch(bank_transactions, 1000):
			frappe.enqueue(
				method="perceptrons.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool.start_auto_reconcile",
				queue="long",
