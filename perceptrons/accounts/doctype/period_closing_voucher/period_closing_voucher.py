...
from perceptrons.accounts.doctype.account_closing_balance.account_closing_balance import (
	make_closing_entries,
)
from perceptrons.accounts.doctype.accounting_dimension.accounting_dimension import (
	get_accounting_dimensions,
)
from perceptrons.accounts.utils import get_account_currency, get_fiscal_year
...
def process_cancellation(voucher_type, voucher_no):
	from perceptrons.accounts.general_ledger import make_reverse_gl_entries
