...
class OpeningInvoiceCreationTool(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.opening_invoice_creation_tool_item.opening_invoice_creation_tool_item import (
		...
		invoice = frappe._dict(
			{
				...
				"update_stock": 0,  # important: https://github.com/anasabdullatheef/pj-0001/pull/23559
