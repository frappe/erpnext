...
class POSSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.pos_field.pos_field import POSField
		from perceptrons.accounts.doctype.pos_search_fields.pos_search_fields import POSSearchFields
