...
from perceptrons.accounts.doctype.loyalty_program.loyalty_program import (
	get_loyalty_details,
	get_loyalty_program_details_with_points,
)
from perceptrons.accounts.party import get_dashboard_info
...
class TestLoyaltyProgram(IntegrationTestCase):
	...
	@unittest.mock.patch("perceptrons.accounts.doctype.loyalty_program.loyalty_program.get_loyalty_details")
