...
from perceptrons.accounts.doctype.pos_invoice_merge_log.pos_invoice_merge_log import (
	consolidate_pos_invoices,
	unconsolidate_pos_invoices,
)
from perceptrons.controllers.status_updater import StatusUpdater
...
class POSClosingEntry(StatusUpdater):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.pos_closing_entry_detail.pos_closing_entry_detail import (
			POSClosingEntryDetail,
		)
		from perceptrons.accounts.doctype.pos_closing_entry_taxes.pos_closing_entry_taxes import (
			POSClosingEntryTaxes,
		)
		from perceptrons.accounts.doctype.pos_invoice_reference.pos_invoice_reference import POSInvoiceReference
		from perceptrons.accounts.doctype.sales_invoice_reference.sales_invoice_reference import (
