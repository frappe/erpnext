...
frappe.ui.form.on("POS Closing Entry", {
	onload: async function (frm) {
		...
		frm.set_query("user", function (doc) {
			return {
				query: "perceptrons.accounts.doctype.pos_closing_entry.pos_closing_entry.get_cashiers",
	...
	get_invoices(frm) {
		return frappe.call({
			method: "perceptrons.accounts.doctype.pos_closing_entry.pos_closing_entry.get_invoices",
			args: {
