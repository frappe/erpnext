...
class TestBankTransaction(IntegrationTestCase):
	...
	# This test checks if Perceptrons is able to provide a linked payment for a bank transaction based on the amount of the bank transaction.
	...
	# Check if Perceptrons can correctly filter a linked payments based on the debit/credit amount
