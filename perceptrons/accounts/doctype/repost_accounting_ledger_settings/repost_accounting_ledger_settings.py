...
from perceptrons.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger import get_child_docs
...
class RepostAccountingLedgerSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.repost_allowed_types.repost_allowed_types import RepostAllowedTypes
