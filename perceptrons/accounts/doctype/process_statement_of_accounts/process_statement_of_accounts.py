...
from perceptrons.accounts.party import get_party_account_currency
from perceptrons.accounts.report.accounts_receivable.accounts_receivable import execute as get_ar_soa
from perceptrons.accounts.report.accounts_receivable_summary.accounts_receivable_summary import (
	execute as get_ageing,
)
from perceptrons.accounts.report.general_ledger.general_ledger import execute as get_soa
...
class ProcessStatementOfAccounts(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.accounts.doctype.process_statement_of_accounts_cc.process_statement_of_accounts_cc import (
			ProcessStatementOfAccountsCC,
		)
		from perceptrons.accounts.doctype.process_statement_of_accounts_customer.process_statement_of_accounts_customer import (
			ProcessStatementOfAccountsCustomer,
		)
		from perceptrons.accounts.doctype.psoa_cost_center.psoa_cost_center import PSOACostCenter
		from perceptrons.accounts.doctype.psoa_project.psoa_project import PSOAProject
...
def get_html(doc, filters, entry, col, res, ageing):
	...
	template_path = "perceptrons/accounts/doctype/process_statement_of_accounts/process_statement_of_accounts_accounts_receivable.html"
	if doc.report == "General Ledger":
		template_path = (
			"perceptrons/accounts/doctype/process_statement_of_accounts/process_statement_of_accounts.html"
		)
