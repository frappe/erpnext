...
from perceptrons.accounts.doctype.accounting_dimension_filter.accounting_dimension_filter import (
	get_dimension_filter_map,
)
from perceptrons.accounts.doctype.accounting_period.accounting_period import ClosedAccountingPeriod
from perceptrons.accounts.doctype.budget.budget import validate_expense_against_budget
from perceptrons.accounts.utils import create_payment_ledger_entry, is_immutable_ledger_enabled
from perceptrons.controllers.budget_controller import BudgetValidation
from perceptrons.exceptions import InvalidAccountDimensionError, MandatoryAccountDimensionError
...
def merge_similar_entries(gl_map, precision=None):
	...
	company = gl_map[0].company if gl_map else perceptrons.get_default_company()
