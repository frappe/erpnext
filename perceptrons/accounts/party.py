...
from perceptrons.exceptions import InvalidAccountCurrency, PartyDisabled, PartyFrozen
...
def complete_contact_details(party_details):
	...
	if party_details.party_type == "Employee":
		from perceptrons.setup.doctype.employee.employee import _get_contact_details as get_employee_contact
...
def validate_party_accounts(doc):
	from perceptrons.controllers.accounts_controller import validate_account_head
...
def set_taxes(
	...
	from perceptrons.accounts.doctype.tax_rule.tax_rule import get_party_details, get_tax_template
