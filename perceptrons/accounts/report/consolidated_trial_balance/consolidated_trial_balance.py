...
import perceptrons
from perceptrons.accounts.doctype.account.account import get_root_company
from perceptrons.accounts.report.financial_statements import (
	filter_accounts,
	filter_out_zero_value_rows,
	set_gl_entries_by_account,
)
from perceptrons.accounts.report.trial_balance.trial_balance import (
...
from perceptrons.accounts.report.utils import get_rate_as_at
...
def get_company_wise_tb_data(filters, reporting_currency, ignore_reporting_currency):
	...
	default_currency = perceptrons.get_company_currency(filters.company)
...
def get_reporting_currency(filters):
	...
	for company in filters.company:
		company_default_currency = perceptrons.get_company_currency(company)
