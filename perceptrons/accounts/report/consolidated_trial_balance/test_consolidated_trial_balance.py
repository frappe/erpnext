...
from perceptrons.accounts.report.consolidated_trial_balance.consolidated_trial_balance import execute
...
class TestConsolidatedTrialBalance(IntegrationTestCase):
	@classmethod
	def setUpClass(cls):
		from perceptrons.accounts.report.trial_balance.test_trial_balance import create_company
