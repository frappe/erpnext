...
from perceptrons.controllers.taxes_and_totals import get_itemised_tax
from perceptrons.regional.italy import state_codes
from perceptrons.stock.utils import get_default_stock_uom
...
def prepare_and_attach_invoice(doc, replace=False):
	...
	invoice_xml = frappe.render_template(
		"perceptrons/regional/italy/e-invoice.xml",
