...
from perceptrons.support.doctype.issue.issue import calculate_first_response_time, get_holidays
...
class ServiceLevelAgreement(Document):
	...
	if TYPE_CHECKING:
		...
		from perceptrons.support.doctype.pause_sla_on_status.pause_sla_on_status import PauseSLAOnStatus
		from perceptrons.support.doctype.service_day.service_day import ServiceDay
		from perceptrons.support.doctype.service_level_priority.service_level_priority import (
			ServiceLevelPriority,
		)
		from perceptrons.support.doctype.sla_fulfilled_on_status.sla_fulfilled_on_status import (
