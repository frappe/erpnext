...
erpnext.LeadController = wn.ui.form.Controller.extend({
	...
	onload: function() {
		...
		if(in_list(user_roles,'System Manager')) {
			cur_frm.footer.help_area.innerHTML = '<hr>\
				...
				<span class="help">' + wn._('Automatically extract Leads from a mail box e.g. ') + '"' + wn._('sales@example.com')+ '"</span></p>';
		}
	},
	...
	refresh: function() {
		...
		if(!this.frm.doc.__islocal && !this.frm.__is_customer) {
			...
			this.frm.add_custom_button(w._("Send SMS"), this.frm.cscript.send_sms);
		}
